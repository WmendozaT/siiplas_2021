        ...
        foreach($proyectos as $row){
          ...
          $tabla.='<tr style="height:35px;">';
            $tabla .= '<td title="'.$row['proy_id'].' - '.$row['aper_id'].'">';
              if(count($fase)!=0){
                //$tabla .= '<center><a href="'.site_url("").'/prog/list_serv/'.$row['proy_id'].'" title="PROGRAMACION FÍSICA" class="btn btn-default"><img src="'.base_url().'assets/ifinal/bien.png" WIDTH="30" HEIGHT="30"/><br>PROG. FISICA</a></center>';
                if($this->adm==1){ 
...
/*====================================================================================================================*/
    /*--- VERIFICANDO APERTURA PROGRAMATICA GASTO CORRIENTE Y PROYECTO DE INVERSION---*/
    function verif(){
