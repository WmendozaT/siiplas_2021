        ...
        $(function () {
            $("#btsubmit").on("click", function (e) {
                var $validator = $("#formulario").validate({
                    ...
                    messages: {
                        concepto: {required: "<font color=red size=1>REGISTRE DETALLE DE REQUERIMIENTO A MODIFICAR</font>"}
                    },
                ...
                if (!$valid) {
                    ...
                    conp=document.formulario.concepto.value;
                  
                    reset();
                    alertify.confirm("UNIFORMIZAR "+nro+" DETALLES DE REQUERIMIENTOS - EL DETALLE SE CAMBIARAR A "+conp+", <br> DESEA REALIZAR LA MODIFICACIÓN ?", function (a) {
                        if (a) {
