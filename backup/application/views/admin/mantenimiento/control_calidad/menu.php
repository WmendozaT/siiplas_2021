    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mantenimiento</li><li>Ptto. Asignado POA</li><li>Menu - Control de Calidad</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <section id="widget-grid" class="">
                    <div class="row">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                            <div class="row">
                                <div class="well well-sm col-sm-4 animated rotateInDownLeft">
                                    <div class="well well-sm bg-color-teal txt-color-white text-center">
                                        <a href="<?php echo site_url() . '/select_control_calidad/1'?>" class="ruta">
                                          <h5 style="font-weight: bold;font-style: italic;color: white">CONTROL DE CALIDAD POR UNIDAD DE MEDIDA - PARTIDAS</h5>
                                          <i class="fa fa-signal fa-5x icono" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="well well-sm col-sm-4 animated rotateInDownRight">
                                    <div class="well well-sm bg-color-teal txt-color-white text-center">
                                        <a href="<?php echo site_url() . '/select_control_calidad/2'?>" class="ruta">
                                          <h5 style="font-weight: bold;font-style: italic;color: white">CONTROL DE CALIDAD POR CONCEPTO DE REQUERIMIENTO </h5>
                                          <i class="fa fa-signal fa-5x icono" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="well well-sm col-sm-4 animated rotateInDownRight">
                                    <div class="well well-sm bg-color-teal txt-color-white text-center">
                                        <a href="<?php echo site_url() . '/select_control_calidad/3'?>" class="ruta">
                                          <h5 style="font-weight: bold;font-style: italic;color: white">CONTROL DE CALIDAD - UNIDAD DE MEDIDA NULAS</h5>
                                          <i class="fa fa-signal fa-5x icono" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
