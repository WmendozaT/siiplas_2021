      ...
      <tr>
        <td style="width:100%; height: 1.2%; font-size: 12pt;" align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                ...
                <tr>
                    <td style="width:100%; height: 1.2%; font-size: 40pt;" align="center"><?php echo strtoupper($regional[0]['dep_departamento']);?></td>
                </tr>
            </table>
            <hr>
        </td>
...
try{
    ...
    $html2pdf->Output('PRESENTACION_POA_'.strtoupper($regional[0]['dep_departamento']).'-'.$this->session->userdata('gestion').'.pdf');
}
