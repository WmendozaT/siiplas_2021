	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>...</li><li>Objetivos Estrategicos</li><li>Acciones Estrat&eacute;gicas</li><li>Resultados de Mediano Plazo</li><li>Producto Terminal</li><li>Nuevo</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			<!-- MAIN CONTENT -->
			<div id="content">
	                <?php
	                  ...
	                  echo form_open('me/valida_pterminal_mplazo', $attributes);
	                ?>
				<!-- widget grid -->
				...
				<div class="row">
					<!-- row -->
						...
						<input type="hidden" name="rm_id" id="rm_id" value="<?php echo $resultado[0]['rm_id'];?>">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label><font size="1"><b>RESPONSABLE</b></font><font color="blue">(Obligatorio)</font></label>
						...
						<article class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
							<div class="jarviswidget jarviswidget-color-darken" >
								<header>
									<span class="widget-icon"> <i class="fa fa-arrows-v"></i> </span>
									<h2 class="font-md"><strong>PRODUCTO TERMINAL</strong></h2>				
								</header>
								<!-- widget content -->
								<div class="widget-body">
									<div class="well">
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<textarea rows="5" class="form-control" name="pterminal" id="pterminal" style="width:100%;"  title="Registre Producto Terminal" maxlength="600"></textarea> 
											</div>
										</div>
										<div class="col-sm-4">
											<div class="form-group">
										...
										<div class="col-sm-8">
											<div class="form-group">
												...
												<textarea rows="4" class="form-control" style="width:100%;" name="indicador" id="indicador" onclick="suma_programado()" maxlength="200"></textarea> 
											</div>
										</div>
										...
										<div class="row">
											<div class="col-sm-4">
												...
												<label><font size="1"><b>LINEA BASE</b></font></label>
													<input class="form-control" type="text" name="lb" id="lb" value="0" onkeyup="suma_programado_anual()" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }"  onpaste="return false">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input class="form-control" type="text" name="met" id="met" value="0" onkeyup="suma_programado_anual()" placeholder="0 %" onkeyup="javascript:costo_unitario();" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false">
												</div>
											</div>
													...
													<div class="form-group">
														<div class="col-sm-6">
															<div class="form-group">
																...
																<textarea rows="3" name="c_a" id="c_a" class="form-control" onclick="suma_programado()" style="width:100%;" ></textarea> 
															</div>
														</div>
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<textarea rows="3" name="c_b" id="c_b" class="form-control" onclick="suma_programado()" style="width:100%;"></textarea> 
															</div>
														</div>
													</div>
												</div>
							...
							<div class="jarviswidget jarviswidget-color-darken" >
								...
								<div class="widget-body">
									...
									<table class="table table-bordered table-hover" style="width:100%;" >
									    ...
									    <tbody>
									        <tr>
									            <td><input  name="g1" class="form-control" type="text" onkeyup="suma_programado_anual();" style="width:100%;" value="0"  onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false"></td>
									            <td><input  name="g2" class="form-control" type="text" onkeyup="suma_programado_anual();" style="width:100%;" value="0"  onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false"></td>
									            <td><input  name="g3" class="form-control" type="text" onkeyup="suma_programado_anual();" style="width:100%;" value="0"  onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false"></td>
									            <td><input  name="g4" class="form-control" type="text" onkeyup="suma_programado_anual();" style="width:100%;" value="0"  onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false"></td>
									            <td><input  name="g5" class="form-control" type="text" onkeyup="suma_programado_anual();" style="width:100%;" value="0"  onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false"></td>
									        </tr>
									    </tbody>
									</table>
								</div>
								...
								<a href="<?php echo base_url().'index.php/me/pterminales_mp/'.$resultado[0]['rm_id'] ?>" class="btn btn-lg btn-default" title="VOLVER A MIS PROYECTOS"> CANCELAR </a>
								<input type="button" value="GUARDAR PRODUCTO" id="btsubmit" class="btn btn-primary btn-lg" onclick="valida_envia_pterminal_multi()" title="GUARDAR REGISTRO - PRODUCTO TERMINAL">
							</div>
						</article>
						</form>
					</div>
