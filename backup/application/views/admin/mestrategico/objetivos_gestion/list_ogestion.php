	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>...</li><li>Objetivos Estrategicos</li><li>Acciones Estrat&eacute;gicas</li><li>Objetivos de Gesti&oacute;n</li>
				</ol>
			</div>
			<!-- MAIN CONTENT -->
			<div id="content">
	                        ...
	                        <section id="widget-grid" class="well">
	                            <div class="">
	                            	<h1>OBJETIVO ESTRAT&Eacute;GICO : <small><?php echo $obj_estrategico[0]['obj_codigo'].' .-'.$obj_estrategico[0]['obj_descripcion'];?></small></h1>
	                              	...
	                              	<h1>OBJETIVOS DE GESTI&Oacute;N - <?php echo $this->session->userData('gestion') ?></h1>
	                            </div>
	                        </section>
	                    </article>
                            ...
                            <section id="widget-grid" class="well">
                              <center>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:abreVentana('<?php echo site_url("").'/me/rep_objetivos_gestion/'.$accion_estrategica[0]['acc_id'];?>');">IMPRIMIR RESULTADOS</a></li>
                    ...
                    <div class="row">
                      <section class="col col-4">
                        ...
                        <label class="textarea">
                          ...
                          <textarea rows="2" name="ogestion" id="ogestion" title="REGISTRAR OBJETIVO"></textarea>
                        </label>
                      </section>
                      <section class="col col-4">
                        ...
                        <label class="textarea">
                          <i class="icon-append fa fa-tag"></i>
                          <textarea rows="2" name="producto" id="producto" title="REGISTRAR PRODUCTO"></textarea>
                        </label>
                      </section>
                      <section class="col col-4">
