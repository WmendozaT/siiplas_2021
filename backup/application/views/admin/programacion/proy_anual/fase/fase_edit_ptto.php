	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Programaci&oacute;n de Operaciones</li><li><a href="<?php echo base_url().'index.php/admin/proy/list_proy_fin' ?>" title="MIS PROYECTOS">T&eacute;cnico Analista Financiero</a></li><li>Presupuesto Techo Asignado</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			<!-- MAIN CONTENT -->
	                    ...
	                    <article class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
						    <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="false" data-widget-custombutton="false">
						        <header>
						          ...
						          <h2>MODIFICAR ASIGNACI&Oacute;N TECHO PRESUPUESTO</h2>       
						        </header>
						        <div>
			        ...
			        if (!$valid) {
			            ...
			            for (var i = 1; i <= nro; i++) {
			            	if((document.getElementById('fi'+i).value=='') || (document.getElementById('ofi'+i).value=='') || (document.getElementById('impo'+i).value=='' || document.getElementById('impo'+i).value==0)){
			            		...
			            		document.form_techo.proy_id.focus() 
                    			return 0;
			            	}
			            	else{
		...
		"<td><select class='form-control' name='ofin[]' id='ofi"+(cant)+"' title='Organismo Financiador' required ><option value=''>Seleccione Organismo Financiador</option><?php
		  ...
		  ?></select></td>"+
		"<td><input class='form-control' type='text' name='importe[]' id='impo"+(cant)+"' value='0' onkeyup='suma_monto_techo();' onkeypress='if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }' onpaste='return false'/></td>"+
		"<td></td>";
		...
		<script type="text/javascript">
		    $(function () {
		        ...
		        $(".del_ff").on("click", function (e) {
		            ...
		            var request;
		            // confirm dialog
		            alertify.confirm("DESEA ELIMINAR ASIGNACIÓN PRESUPUESTARIA?", function (a) {
		                if (a) { 
		                    url = "<?php echo site_url("")?>/proy/delete_asignacion";
		                    if (request) {
		                        request.abort();
		                    }
		                    request = $.ajax({
		                    ...
		                    request.done(function (response, textStatus, jqXHR) { 
			                    ...
			                    if (response.respuesta == 'correcto') {
			                        alertify.alert("LA ASIGNACIÓN SE ELIMINO CORRECTAMENTE ", function (e) {
			                            if (e) {
			                                window.location.reload(true);
			                            }
			                        });
			                    } else {
			                        alertify.alert("ERROR AL ELIMINAR ASIGNACIÓN PRESUPUESTARIA !!!", function (e) {
			                            if (e) {
			                                window.location.reload(true);
			                            }
			                        });
