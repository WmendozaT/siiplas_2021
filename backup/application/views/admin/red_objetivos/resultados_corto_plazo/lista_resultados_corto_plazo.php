    ...
    <head>
        ...
        <script>
            function abreVentana(PDF){
                var direccion;
                direccion = '' + PDF;
                window.open(direccion, "Reporte de Resultados de Corto Plazo" , "width=800,height=650,scrollbars=SI") ;
            }                                                  
        </script>
        <style>
            .table{
    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>...</li><li>Red de Acciones</li><li>Acciones de Mediano Plazo</li><li>Resultados de Corto Plazo</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                            <section id="widget-grid" class="well">
                                <div class="">
                                  ...
                                  <h1> ACCI&Oacute;N ESTRAT&Eacute;GICA DE MEDIANO PLAZO : <small><?php echo $accion_estrategica[0]['acc_descripcion'];?></small>
                                </div>
                            </section>
                        </article>
                            ...
                            <section id="widget-grid" class="well">
                              <center>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                  <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:abreVentana('<?php echo site_url("").'/prog/reporte_resultado_cp/'.$dato_poa[0]['poa_id'].'/'.$accion_estrategica[0]['acc_id']; ?>');">IMPRIMIR ACCIONES DE CORTO PLAZO</a></li>
                                  <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url().'index.php/prog/obj/'.$dato_poa[0]['poa_id'].'' ?>">VOLVER ATRAS</a></li>
                                </ul>
                              </div>
                              </center>
                            </section>
        ...
        $(function () {
            ...
            $(".del_ff").on("click", function (e) {
                ...
                var request;
                // confirm dialog
                alertify.confirm("REALMENTE DESEA ELIMINAR ESTE RESULTADO ?", function (a) {
                    if (a) { 
                        url = "<?php echo site_url("admin")?>/prog/rcp_delete";
                        if (request) {
                            request.abort();
                        }
                        request = $.ajax({
            ...
            $(".del_ffi").on("click", function (e) {
                ...
                alertify.confirm("REALMENTE DESEA ELIMINAR ESTE INDICADOR ?", function (a) {
                    if (a) { 
                        url = "<?php echo site_url("admin")?>/prog/rcp_delete_ind";
                        if (request) {
                            request.abort();
                        }
                        request = $.ajax({
