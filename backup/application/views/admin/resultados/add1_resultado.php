	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Programaci&oacute;n del POA</li><li>Marco Estrat&eacute;gico</li><li>Acciones de Mediano Plazo</li><li>Nuevo Registro</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			...
			<div id="content">
	                <?php
	                  ...
	                  echo form_open('admin/me/add1', $attributes);
	                ?>
				<!-- widget grid -->
					...
					<!-- row -->
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<div class="row">
										<div class="col-sm-10">
											<div class="form-group">
												...
												<textarea rows="5" class="form-control" name="resultado" id="resultado" style="width:100%;"  title="Ingrese Nombre del Proyecto, Actividad" ></textarea> 
											</div>
										</div>
										<div class="col-sm-2">
											<div class="form-group">
												<label><font size="1"><b>NRO DE INDICADORES </b></font><font color="blue">(Obligatorio)</font></label>
													<select class="form-control" id="nro" name="nro" title="Seleccione Nro de Indicadores">
														<option value="">Seleccione</option>
										...
										<div class="col-sm-2">
											<div class="form-group">
												...
												<input class="form-control" type="text" name="pn_cion" id="pn_cion" value="0" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false">
											</div>
										</div>																		
									</div>
								</div>
							...
							<div class="form-actions">
								<a href="<?php echo base_url().'index.php/admin/me/resultados' ?>" class="btn btn-lg btn-default" title="VOLVER A MIS PROYECTOS"> CANCELAR </a>
								<input type="button" value="GUARDAR ACCI&Oacute;N" id="btsubmit" class="btn btn-primary btn-lg" onclick="valida_envia()" title="GUARDAR ACCION DE MEDIANO PLAZO">
							</div>
						</form>
					</div>
		...
		<script>
            ...
            { 
                if (document.formulario.fun_id.value==""){ 
                    alertify.alert("SELECCIONE RESPONSABLE DE LA ACCIÓN DE MEDIANO PLAZO") 
                ...
                if (document.formulario.resultado.value==""){ 
                    alertify.alert("REGISTRE ACCIÓN DE MEDIANO PLAZO") 
                    document.formulario.resultado.focus() 
                    return 0; 
                }

                if (document.formulario.nro.value==""){ 
                    alert("SELECCIONE NRO DE INDICADORES") 
                    document.formulario.nro.focus() 
                    return 0; 
                }

                alertify.confirm("GUARDAR ACCI\u00D3N DE MEDIANO PLAZO ?", function (a) {
                    if (a) {
