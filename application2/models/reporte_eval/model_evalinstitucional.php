...
class Model_evalinstitucional extends CI_Model{
    ...
    public function list_operaciones_evaluadas_unidad_trimestre_tipo_nacional($trimestre,$tipo_eval,$tp_id){
        $sql = 'select poa.*,c.*,pt.*
                ...
                where c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.' and (poa.prog!=\'97\' and poa.prog!=\'98\' and poa.prog!=\'99\')
        ...
        /*if($this->gestion>2022){ /// 2023
            $sql = 'select poa.*,c.*,pt.*
                ...
                Inner Join _productos as p On p.com_id=c.com_id
                Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
                where c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.' and (poa.prog!=\'098\' and poa.prog!=\'099\' and poa.prog!=\'720\')
                order by pt.tprod_id asc';
        }
        else{ /// 2022
            $sql = 'select poa.*,c.*,pt.*
                ...
                Inner Join _productos as p On p.com_id=c.com_id
                Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
                where c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.'
                order by pt.tprod_id asc';
        }*/
    ...
    public function nro_operaciones_programadas_nacional($trimestre,$tp_id){
        $sql = 'select count(*) total
                ...
                Inner Join (
                        ...
                        where (m_id>\'0\' and m_id<='.($trimestre*3).') and pg_fis!=\'0\'
                        group by prod_id
...
/*        if($trimestre==1){
    ...
    public function list_operaciones_evaluadas_unidad_trimestre_tipo_regional($dep_id,$trimestre,$tipo_eval,$tp_id){
        $sql = '
            ...
            Inner Join _productos as p On p.com_id=c.com_id
            Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
            where poa.dep_id='.$dep_id.' and c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.' and (poa.prog!=\'97\' and poa.prog!=\'98\' and poa.prog!=\'99\')
            order by pt.tprod_id asc';
        ...
        /*if($this->gestion>2022){ /// 2023
            ...
            Inner Join _productos as p On p.com_id=c.com_id
            Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
            where poa.dep_id='.$dep_id.' and c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.' and (poa.prog!=\'098\' and poa.prog!=\'099\' and poa.prog!=\'720\')
            order by pt.tprod_id asc';
        }
        else{ /// 2022
            $sql = '
            ...
            Inner Join _productos as p On p.com_id=c.com_id
            Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
            where poa.dep_id='.$dep_id.' and c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.'
            order by pt.tprod_id asc';
        }*/
    ...
    /*----- NUMERO DE ACTIVIDADES (FORM 4) PROGRAMADAS POR TRIMESTRE / REGIONAL ------*/
    ...
    public function nro_operaciones_programadas_regionalL($dep_id,$trimestre,$tp_id){
        //// $tp_id : 1 - Proyectos de Inversion
        //// $tp_id : 4 - Gasto Corriente
...
/*    public function suma_operaciones_ejecutadas_regional($dep_id,$trimestre){
    ...
    public function list_operaciones_evaluadas_unidad_trimestre_tipo_distrital($dist_id,$trimestre,$tipo_eval,$tp_id){
        $sql = '
                ...
                Inner Join _productos as p On p.com_id=c.com_id
                Inner Join _productos_trimestral as pt On pt.prod_id=p.prod_id
                where poa.dist_id='.$dist_id.' and c.estado!=\'3\' and p.estado!=\'3\' and pt.testado!=\'3\' and (pt.trm_id>\'0\' and pt.trm_id<='.$trimestre.') and pt.tp_eval='.$tipo_eval.' and (poa.prog!=\'97\' and poa.prog!=\'98\' and poa.prog!=\'99\')
                order by pt.tprod_id asc';
          /*  if($this->gestion>2022){ /// 2023
                $sql = '
                select poa.*,c.*,pt.*
    ...
    public function nro_operaciones_programadas_distrital($dist_id,$trimestre,$tp_id){
        $sql = '
            select poa.dist_id, count(*) total
            from lista_poa_gastocorriente_nacional('.$this->gestion.') poa
            Inner Join _componentes as c On c.pfec_id=poa.pfec_id
            Inner Join _productos as prod On prod.com_id=c.com_id
            ...
            Inner Join (
                    select prod_id
                    from prod_programado_mensual
                    where (m_id>=\'3\' and m_id<='.($trimestre*3).') and pg_fis!=\'0\'
                    group by prod_id
                ) as pprog On pprog.prod_id=prod.prod_id
...
/*        if($trimestre==1){
    ...
    public function suma_operaciones_programadas_distrital($dist_id,$trimestre){
         $sql = '
                select poa.dist_id, count(*) total, SUM(temp.pg_fis) suma_programado
                from lista_poa_gastocorriente_nacional('.$this->gestion.') poa
                Inner Join _componentes as c On c.pfec_id=poa.pfec_id
                Inner Join _productos as p On p.com_id=c.com_id
                Inner Join prod_programado_mensual as temp On temp.prod_id=p.prod_id
                where poa.dist_id='.$dist_id.' and c.estado!=\'3\' and p.estado!=\'3\' and temp.pg_fis!=\'0\' and (temp.m_id>=\'0\' and temp.m_id<='.($trimestre*3).') and (poa.prog!=\'97\' and poa.prog!=\'98\' and poa.prog!=\'99\')
                group by poa.dist_id';
    ...
    public function suma_operaciones_ejecutadas_distrital($dist_id,$trimestre){
        $sql = 'select poa.dist_id, count(*) total, SUM(ejec.pejec_fis) suma_evaluado
                ...
                Inner Join _productos as p On p.com_id=c.com_id
                Inner Join prod_ejecutado_mensual as ejec On ejec.prod_id=p.prod_id
                where poa.dist_id='.$dist_id.' and c.estado!=\'3\' and p.estado!=\'3\' and ejec.pejec_fis!=\'0\' and (ejec.m_id>\'0\' and ejec.m_id<='.($trimestre*3).') and (poa.prog!=\'97\' and poa.prog!=\'98\' and poa.prog!=\'99\')
                group by poa.dist_id';
    ...
    public function monto_total_programado_trimestre_institucional($tp_id){
        ...
        if($tp_id==1){
            $sql = '
                ...
                where i.ins_estado!=\'3\' and i.aper_id!=\'0\' and (t.mes_id>\'0\' and t.mes_id<='.($this->tmes*3).') 
    ...
    public function monto_total_programado_trimestre_por_regional($tp_id,$dep_id){
        if($tp_id==1){
            $sql = 'select p.dep_id, SUM(t.ipm_fis) ppto_programado
                ...
                Inner Join temporalidad_prog_insumo as t On t.ins_id=i.ins_id  
                where p.dep_id='.$dep_id.' and i.ins_estado!=\'3\' and i.aper_id!=\'0\' and (t.mes_id>\'0\' and t.mes_id<='.($this->tmes*3).') and t.g_id='.$this->gestion.' and apg.aper_gestion='.$this->gestion.' and p.tp_id=\'1\'
                group by p.dep_id';
        }
        else{
            $sql = 'select p.dep_id, SUM(t.ipm_fis) ppto_programado
                ...
                Inner Join temporalidad_prog_insumo as t On t.ins_id=i.ins_id  
                where p.dep_id='.$dep_id.' and i.ins_estado!=\'3\' and i.aper_id!=\'0\' and (t.mes_id>\'0\' and t.mes_id<='.($this->tmes*3).') and t.g_id='.$this->gestion.' and apg.aper_gestion='.$this->gestion.' and ua.act_estado!=\'3\' and ug.g_id='.$this->gestion.' and p.tp_id=\'4\'
                group by p.dep_id';
        }
    ...
    public function monto_total_programado_trimestre_por_distrital($tp_id,$dist_id){
        if($tp_id==1){
            $sql = 'select p.dist_id, SUM(t.ipm_fis) ppto_programado
                ...
                Inner Join temporalidad_prog_insumo as t On t.ins_id=i.ins_id  
                where p.dist_id='.$dist_id.' and i.ins_estado!=\'3\' and i.aper_id!=\'0\' and (t.mes_id>\'0\' and t.mes_id<='.($this->tmes*3).') and t.g_id='.$this->gestion.' and apg.aper_gestion='.$this->gestion.' and p.tp_id=\'1\'
                group by p.dist_id';
        }
        else{
            $sql = 'select p.dist_id, SUM(t.ipm_fis) ppto_programado
                ...
                Inner Join temporalidad_prog_insumo as t On t.ins_id=i.ins_id  
                where p.dist_id='.$dist_id.' and i.ins_estado!=\'3\' and i.aper_id!=\'0\' and (t.mes_id>\'0\' and t.mes_id<='.($this->tmes*3).') and t.g_id='.$this->gestion.' and apg.aper_gestion='.$this->gestion.' and ua.act_estado!=\'3\' and ug.g_id='.$this->gestion.' and p.tp_id=\'4\'
                group by p.dist_id';
        }
