...
<div id="main" role="main">
    <div id="ribbon">
        <ol class="breadcrumb">
            <li>Inicio</li><li>Marco Estrategico</li><li>Misi&oacute;n Institucional</li>
        </ol>
    </div>
    <div id="content">
        <div class="row">
            ...
            <div class="col-md-10 animated fadeInDown" align="center">
                <div class="alert alert-block alert-success" style="background-color: #568A89; color:white; height:50px; margin: 0 auto;">
                    <h4 style=""><i class="icon fa fa-check" style="color:#e7f3ff;">&nbsp;</i>MISIÓN INSTITUCIONAL</h4>
                </div>
            </div>
        </div><br>
        <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="comment-text-area">
                                                <textarea id="vmision" name="vmision" class="textinput" placeholder="Ingrese Misión" rows="12" disable><?php  echo $mision[0]['conf_mision'];?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div><br>
