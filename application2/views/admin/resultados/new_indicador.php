	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>Programaci&oacute;n del POA</li><li>Marco Estrat&eacute;gico</li><li>Acci&oacute;n de Mediano Plazo</li><li>Registro de Indicadores (Nuevo)</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			<!-- MAIN CONTENT -->
			<div id="content">
	                <?php
	                  ...
	                  echo form_open('admin/me/valida_ind', $attributes);
	                ?>
				<!-- widget grid -->
					...
					<!-- row -->
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
							<div class="jarviswidget jarviswidget-color-darken" >
								<header>
									...
									<h2 class="font-md"><strong>NUEVO REGISTRO INDICADOR <?php echo $nro;?></strong></h2>				
								</header>
								<!-- widget content -->
											...
											<div class="row">
												...
												<div class="col-sm-8">
													<div class="form-group">
														...
														<textarea rows="5" class="form-control" style="width:100%;"  name="indicador" id="indicador"></textarea> 
													</div>
												</div>
											</div>
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
							...
							<div class="form-actions">
								<a href="<?php echo base_url().'index.php/admin/me/resultados' ?>" class="btn btn-lg btn-default" title="VOLVER A LISTA DE ACCIONES DE MEDIANO PLAZO"> CANCELAR </a>
								<input type="button" value="GUARDAR INDICADOR <?php echo $nro;?>" id="btsubmit" class="btn btn-primary btn-lg" onclick="valida_envia_indicador()" title="GUARDAR REGISTRO">
								</div>
							</div>			
						</article>
						</form>
