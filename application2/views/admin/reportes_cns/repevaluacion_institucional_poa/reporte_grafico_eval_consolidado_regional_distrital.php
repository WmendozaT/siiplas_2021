                    ...
                    <div>
                        ...
                        <div class="widget-body">
                            ...
                            <ul id="myTab1" class="nav nav-tabs bordered">
                                ...
                                <li>
                                    <a href="#s3" data-toggle="tab"> Parametros de cumplimiento POA</a>
                                </li>
                                <li>
                                    <a href="#s4" data-toggle="tab"> Ejec. POA por Programas</a>
                                </li>
                                <li>
                                    <a href="#s5" data-toggle="tab"> Ejecucion Cert. POA.</a>
                                </li>
                                <li>
