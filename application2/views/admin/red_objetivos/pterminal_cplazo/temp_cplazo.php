	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>...</li><li>...</li><li>...</li><li>Resultados de Corto Plazo</li><li>Producto Terminal de Corto Plazo</li><li>Temporalidad de Corto Plazo</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			...
			<div id="content">
	                <?php
	                  ...
	                  echo form_open('prog/valida_temporalidad_ptcplazo', $attributes);
	                ?>
				<!-- widget grid -->
				...
				<div class="row">
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <section id="widget-grid" class="well">
                                <div class="">
                                  ...
                                  <h1> RESULTADO DE CORTO PLAZO : <small><?php echo $resultado[0]['rm_resultado'];?></small></h1>
                                  <h1> PRODUCTO TERMINAL DE CORTO PLAZO : <small><?php echo $pterminal[0]['ptm_producto'];?></small> || PROGRAMADO GESTI&Oacute;N <?php echo $this->session->userData('gestion'); ?>: <small><?php echo $prog[0]['ptmp_prog'];?></small></h1>
                                </div>
                            </section>
                        </article>
                    </div>
					...
					<!-- row -->
						...
						<input type="hidden" name="lb" value="<?php echo $pterminal[0]['ptm_linea_base']?>">
						<input type="hidden" name="ptmp_id" value="<?php echo $prog[0]['ptmp_id']?>">
						<input type="hidden" name="g_id" value="<?php echo $prog[0]['ptmp_prog']?>">
						<article class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
							...
							<div class="jarviswidget jarviswidget-color-darken" >
								...
								<a href="<?php echo base_url().'index.php/prog/pterminal_cp/'.$dato_poa[0]['poa_id'].'/'.$resultado[0]['rm_id'].'' ?>" class="btn btn-default" title="VOLVER A MIS RESULTADOS"> CANCELAR </a>
