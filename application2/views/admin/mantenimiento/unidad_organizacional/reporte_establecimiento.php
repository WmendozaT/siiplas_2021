...
<page backtop="46mm" backbottom="20mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                ...
                <td style="width: 100%; text-align: left">
                    <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:99.3%;">
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td width=60%; align=center style="font-size: 22px;">
                            <FONT FACE="courier new"><b><?php echo $this->session->userdata('entidad');?></b></FONT>
                          </td>
        ...
        <div align="center">TIPO DE ESTABLECIMIENTOS <?php echo $this->session->userdata('gestion')?></div><br>
    </page_header>
    <page_footer>
        <hr>
