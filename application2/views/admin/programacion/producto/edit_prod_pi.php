      ...
      <div id="ribbon">
        ...
        <ol class="breadcrumb">
        	<?php
        		...
        		<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy#tabs-a'?>" title="VOLVER A MIS PROYECTOS">Mis Proyectos</a></li><li><a href="#" title="MIS COMPONENTES">Mis Componentes</a></li><li>Modificar Operaci&oacute;n</li> 
        			<?php
        		}
        		else{?>
        		<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy' ?>" title="VOLVER A MIS PROYECTOS">Mis Operaciones</a></li><li><a href="<?php echo base_url().'index.php/admin/prog/list_comp/'.$mod.'/'.$id_f[0]['id']."/".$id_f[0]['proy_id'] ?>" title="SUB ACTIVIDADES">Sub Actividades</a></li><li>Modificar Operaci&oacute;n</li> 
        			<?php
        		}
        	?>
        </ol>
					...
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<section id="widget-grid" class="well">
						          <div class="">
						            <h1> PROYECTO DE INVERSI&Oacute;N : <?php echo $proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad']?> - <small><?php echo $proyecto[0]['proy_nombre']?></small><br>
						            <h1> COMPONENTE: <small><?php echo $componente[0]['com_nro'].' - '.$componente[0]['com_componente'];?></small>
						          </div>
							</section>
						</article>
						<article class="col-sm-12">
							<form id="formulario" name="formulario" method="post" action="<?php echo site_url("").'/programacion/producto/modificar_producto_pi'?>">
									...
									<div class="widget-body">
										<div class="row">
													...
													<fieldset>
														...
														<section>
															<div class="col-sm-4">
																...
																<input class="form-control" type="text" name="lb" id="lb" value="<?php echo round($producto[0]['prod_linea_base'],2);?>" onkeyup="suma_prog();" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false" title="REGISTRE LINEA BASE DE LA OPERACIÓN">
															</div>
											...
											<div class="col-sm-6">
												...
												<div class="well">
													<b>TEMPORALIDAD - F&Iacute;SICA</b>
													<fieldset>
														<section>
															<?php
															...
															<table style="width:100%;" >
																<tr>
																	<td>
																		<input class="form-control" name="total" type="text" id="total" value="<?php echo round(($prog+$producto[0]['prod_linea_base']),2);?>" disabled="true" style="width:100%;" >
																	</td>
																</tr>
															</table>
														</section>
		    ...
		    $("#btsubmit").on("click", function (e) {
		        var $validator = $("#formulario").validate({
		            ...
		            messages: {
		                ...
		                met: {required: "<font color=red size=1>REGISTRE META </font>"},
