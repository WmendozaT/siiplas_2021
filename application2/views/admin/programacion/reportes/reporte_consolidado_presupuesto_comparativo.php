...
?>
    ...
    <page backtop="75mm" backbottom="23mm" backleft="8mm" backright="8mm" pagegroup="new">
        <page_header>
...
try{
    ...
    $html2pdf->Output('REP -'.$proyecto[0]['abrev'].'-'.$proyecto[0]['tipo'].' '.$proyecto[0]['proy_nombre'].'_CONSOLIDADO_PARTIDA_CONSOLIDADO.pdf');
}
