  ...
  public function __construct (){
    ...
    public function objetivos_regionales(){
      ...
      if($this->tp_adm==1){
       ...
       /*$meta_evaluado=$this->model_evaluacion->get_evaluacion_meta_oregional(34);
          ...
          if(count($meta_evaluado)!=0){
            $result = array(
              ...
              //'total_evaluado' => ($meta_regional[0]['prog_fis']-$this->get_suma_evaluado($meta_evaluado[0]['pog_id'])), /// Valor Evaluado 
            );
          }*/

         // echo $this->get_suma_evaluado($meta_evaluado[0]['pog_id'],$meta_evaluado[0]['trm_id']).'----'.$meta_evaluado[0]['trm_id'].'----> anterior : '.($meta_regional[0]['prog_fis']-$this->get_suma_evaluado($meta_evaluado[0]['pog_id'],$meta_evaluado[0]['trm_id']));
