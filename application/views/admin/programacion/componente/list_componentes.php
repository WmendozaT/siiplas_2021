	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy';?>" title="POA">Programaci&oacute;n POA</a></li><li>Programaci&oacute;n F&iacute;sica</a></li><li>Mis SubActividades</li>
				</ol>
			</div>
			<!-- END RIBBON -->
					...
					<article class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
						<section id="widget-grid" class="well">
							<ul class="nav nav-pills">
							  <li class="active" title="<?php echo $proyecto[0]['act_id'];?>"><a href="#">MIS SUBACTIVIDAD</a></li>
