        ...
        <ol class="breadcrumb">
        	<?php
        		if($proyecto[0]['tp_id']==1){ ?>
        			<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy'?>" title="MIS POA">Programaci&oacute;n POA</a></li><li>...</li><li><a href="<?php echo base_url().'index.php/prog/list_serv/'.$fase[0]['proy_id'] ?>" title="Mis Componentes">Mis Componentes</a></li><li>Modificar Operaci&oacute;n</li> 
        			<?php
        		}
        		else{ ?>
        			<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy'?>" title="MIS POA">Programaci&oacute;n POA</a></li><li>...</li><li><a href="<?php echo base_url().'index.php/prog/list_serv/'.$fase[0]['proy_id'] ?>" title="Mis Servicios">Mis Servicios</a></li><li>Modificar Datos Actividad</li> 
        			<?php
        		}
        	?>
        </ol>
				...
				<section id="widget-grid" class="">
					<div class="row">
						...
						<article class="col-sm-12">
							<form id="formulario" name="formulario" method="post" action="<?php echo site_url("").'/programacion/producto/modificar_producto'?>">
							...
							<div class="jarviswidget" id="wid-id-8" data-widget-colorbutton="false" data-widget-editbutton="false">
								<header>
									...
									<h2>MODIFICAR DATOS ACTIVIDAD</h2>
								</header>
								<!-- widget div-->
								<div>
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="well">
													<fieldset>
														<section>
															<label class="label" id="col"><b>COD. : <?php echo $producto[0]['prod_cod'];?>.- ACTIVIDAD</b></label>
								                            <textarea rows="3" class="form-control" style="width:100%;" name="prod" id="prod" title="REGISTRE DESCRIPCIÓN DE LA OPERACIÓN"><?php echo $producto[0]['prod_producto'];?></textarea> 
														</section><br>
														...
														<section>
								                            ...
								                            <textarea rows="3" class="form-control" style="width:100%;" name="indicador" id="indicador" title="REGISTRE DESCRIPCIÓN DEL INDICADOR"><?php echo $producto[0]['prod_indicador'];?></textarea> 
														</section><br>
														...
														<section>
															<div class="col-sm-4">
																...
																<input class="form-control" type="text" name="lb" id="lb" value="<?php echo round($producto[0]['prod_linea_base'],2);?>" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false" title="REGISTRE LINEA BASE DE LA OPERACIÓN">
															</div>
														...
														<section>
								                            ...
								                            <textarea rows="3" class="form-control" style="width:100%;" name="verificacion" id="verificacion" title="REGISTRE MEDIO DE VERIFICACIÓN"><?php echo $producto[0]['prod_fuente_verificacion'];?></textarea> 
														</section><br>
													</fieldset>
												</div>
											</div>
									...
									<div class="col-sm-12">
										<div id="but" align="right">
											...
											<input type="button" value="MODIFICAR DATOS ACTIVIDAD" id="btsubmit" class="btn btn-primary" title="GUARDAR DATOS ACTIVIDAD"><br><br>
										</div>
									</div>
								</div>
							</div>
