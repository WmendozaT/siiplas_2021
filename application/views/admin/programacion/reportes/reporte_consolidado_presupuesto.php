...
?>
    ...
    <page backtop="45mm" backbottom="36mm" backleft="8mm" backright="8mm" pagegroup="new">
        <page_header>
                              ...
                              <td width=65%; align=left>
                                <table>
                                    ...
                                    if($this->session->userdata('gestion')!=2020){ ?>
                                        <tr style="font-size: 8pt;">
                                            <td style="height: 1%"><b><?php if($proyecto[0]['tp_id']==1){ echo "PROY. INV. ";}else{ echo "ACTIVIDAD ";} ?></b></td>
                                        ...
                                        <tr style="font-size: 8pt;">
                                            <td style="height: 1%"><b><?php if($proyecto[0]['tp_id']==1){ echo "PROY. INV. ";}else{ echo $proyecto[0]['tipo_adm'];} ?></b></td>
            ...
            <div align="center">PLAN OPERATIVO ANUAL <?php echo $this->session->userdata('gestion')?> - PROGRAMACI&Oacute;N F&Iacute;SICO FINANCIERO <?php if($proyecto[0]['proy_estado']==1){ echo "<b>(ANTEPROYECTO)</b>";} ?><br><b>CONSOLIDADO PRESUPUESTO TOTAL</b></div>
                ...
                <tr>
                    <td style="width: 33%;">
                        <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                            <tr>
                                <td style="width:100%;font-size: 7px; height:12px;"><b>JEF. DE UNIDAD O AREA / REP. DE AREA REGIONALES</b></td>
                            </tr>
                            <tr>
                    ...
                    <td style="width: 33%;">
                        <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                            <tr>
                              <td style="width:100%;font-size: 7px;height:12px;"><b>JEF. DE DPTOS / SERV. GENERALES REGIONAL / JEF. MEDICA </b></td>
                            </tr>
                            <tr>
                              <td align=center><br><br><br><br><br><b>FIRMA</b></td>
                            </tr>
                    ...
                    <td style="width: 33%;">
                        <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                            <tr>
                              <td style="width:100%;font-size: 7px;height:12px;"><b>GERENCIA GENERAL / GERENCIAS DE AREA / ADM. REGIONAL </b></td>
                            </tr>
                            <tr>
                              <td align=center><br><br><br><br><br><b>FIRMA</b></td>
                            </tr>
...
try{
    ...
    $html2pdf->Output('FORM 5-'.$proyecto[0]['dep_sigla'].'-'.$proyecto[0]['tipo'].' '.$proyecto[0]['proy_nombre'].'_CONSOLIDADO_PARTIDA.pdf');
}
