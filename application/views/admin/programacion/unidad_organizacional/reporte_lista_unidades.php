                        ...
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td width=60%; align=center>
                            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                              ...
                              <tr>
                                <td style="width:100%; height: 1.2%; font-size: 13pt;" align="center">ESTABLECIMIENTOS DE SALUD - <?php echo $this->session->userdata('gestion');?></td>
                              </tr>
                              <tr>
                                <td style="width:100%; height: 1.2%; font-size: 11pt;" align="center"><b>REGIONAL <?php echo strtoupper($dep[0]['dep_departamento']);?></b></td>
                              </tr>
                            </table>     
                          </td>
...
try{
    ...
    $html2pdf->Output('Establecimientos_salud.pdf');
}
