	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy' ?>" title="MIS OPERACIONES">Mis Operaciones</a></li><li>Programaci&oacute;n de Requerimientos - Nivel de Productos</li>
				</ol>
			</div>
					...
					<div class="row">
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
				            <section id="widget-grid" class="well">
				                <div class="">
				                  <h1> PROGRAMACI&Oacute;N DE REQUERIMIENTO A NIVEL DE PRODUCTOS</h1>
				                ...
				                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
				                  ...
				                  <!-- <?php 
				                  	if($this->session->userdata('rol_id')==1){ ?>
				                  		<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url().'index.php/prog/delete_ins_total/'.$proyecto[0]['proy_id'];?>" onclick="return confirmar()" title="ELIMINAR TODOS LOS INSUMOS">ELIMINAR INSUMOS</a></li>
				                  		<?php
				                  	}
				                  ?> -->
				                </ul>
