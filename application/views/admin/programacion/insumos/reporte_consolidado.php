...
<page backtop="46mm" backbottom="29mm" backleft="8mm" backright="8mm" pagegroup="new">
    <page_header>
        ...
        <div align="center">MONTO CONSOLIDADO PROGRAMADO POR PARTIDAS <?php echo $this->session->userdata('gestion')?> - PROGRAMACI&Oacute;N FISICO FINANCIERO</div><br>
    </page_header>
    <page_footer>
        <hr>
        <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:96%;" align="center">
            ...
            <tr>
                ...
                <td style="width: 33%; text-align: right">
                    <?php echo "SEP. / " . date("Y").', '.$this->session->userdata('funcionario'); ?> - pag. [[page_cu]]/[[page_nb]]
                </td>
            </tr>
            <tr>
                <td colspan="3"><br></td>
    ...
    <?php
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:80%;" align="center">
            <thead>
                <tr class="modo1">
                    <th style="width:1%;" style="background-color: #1c7368; color: #FFFFFF">Nro</th>
            ...
            <tbody>
                <?php
                    ...
                    foreach ($partidas as $row){ 
                        ...
                        ?>
                        <tr class="modo1">
                            <td style="width: 1%; text-align: center" style="height:13px;"><?php echo $nro;?></td>
                            <td style="width: 10%; text-align: left;"><?php echo $row['codigo'];?></td>
                            <td style="width: 50%; text-align: left;"><?php echo $row['nombre'];?></td>
