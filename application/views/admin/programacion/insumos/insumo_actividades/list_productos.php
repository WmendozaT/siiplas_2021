	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy#tabs-a' ?>" title="MIS PROYECTOS">Mis Proyectos</a></li><li>Programaci&oacute;n de Requerimientos - Nivel de Actividades</li>
				</ol>
			</div>
				...
				<section id="widget-grid" class="">
					<div class="row">
			            ...
			            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<header>
								<span class="widget-icon"> <i class="fa fa-table"></i> </span>
								<h2>OPERACIONES DEL PROYECTO</h2>
							</header>
							<!-- widget div-->
							<div>
								<!-- widget edit box -->
