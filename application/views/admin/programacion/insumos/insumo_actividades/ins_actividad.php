	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy#tabs-a' ?>" title="MIS PROYECTOS">Mis Proyectos</a></li><li>Programaci&oacute;n de Requerimientos - Nivel de Actividades</li><li>Requerimientos</li>
				</ol>
			</div>
			<!-- MAIN CONTENT -->
			<div id="content">
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
				            <section id="widget-grid" class="well">
				                <div class="">
				                  ...
				                  <h1> ACTIVIDAD : <small><?php echo $actividad[0]['act_actividad'];?></small>
				                </div>
				            </section>
				        </article>
				            ...
				            <section id="widget-grid" class="well">
				              ...
				              <center>
				                ...
				                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
				                  	...
				                  	<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url().'index.php/admin/proy/list_proy#tabs-a';?>" title="LISTA DE PROYECTOS">LISTA DE PROYECTOS</a></li>
				                	<?php 
				                		if($monto_saldo>50){?>
				                		<li role="presentation"><a role="menuitem" tabindex="-1" href="#" data-toggle="modal" data-target="#modal_importar_ff" class="btn btn-success" title="IMPORTAR ARCHIVO DE REQUERIMIENTOS"><font color="#ffffff">IMPORTAR REQUERIMIENTOS A LA ACTIVIDAD</font></a></li>
				                		<?php
				                		}
					                  	if($this->session->userdata('rol_id')==1){ ?>
					                  		<li role="presentation"><a onclick="eliminar_requerimientos()" class="btn btn-danger" style="width:100%;" title="Eliminar los requerimientos de la actividad"><font color="#ffffff">ELIMINAR TODOS LOS REQUERIMIENTOS</font></a></li>
					                  	<?php
					                  	}
					                ?>
					               	<li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url().'index.php/prog/ins/'.$proyecto[0]['proy_id'].'/1/1'; ?>" title="VOLVER ATRAS">VOLVER ATRAS</a></li>
				                </ul>
				              </div>
				              </center>
				            </section>
				                ...
				                <thead>
				                  ...
				                  <tbody>
				                    <tr class="modo1">
				                      <td></td>
				                      <td></td>
				                      <td><?php echo number_format($monto_a, 2, ',', '.'); ?></td>
				                      <td><?php echo number_format($monto_p, 2, ',', '.'); ?></td>
				                      <td><font size="1"><b><?php echo number_format($monto_saldo, 2, ',', '.'); ?></b></font></td>
				                    </tr>
				                  </tbody>
				                </table>
								<div id="tabs">
									...
									<div id="tabs-b">
										<div class="row">
											<a href="javascript:abreVentana('<?php echo site_url("").'/prog/rep_requerimientos_act/'.$actividad[0]['act_id'].'';?>');" title="REPORTE REQUERIMIENTOS DE LA ACTIVIDAD - PDF" class="btn btn-primary" style="width:15.5%;">REQUERIMIENTOS PDF</a>
											<a href="javascript:abreVentana('<?php echo site_url("").'/prog/rep_partidas_act/'.$actividad[0]['act_id'].'';?>');" title="REPORTE CONSOLIDADO DE PARTIDAS DE LA ACTIVIDAD- PDF" class="btn btn-primary" style="width:15.5%;">CONSOLIDADO PDF</a>
											<a href='<?php echo site_url("").'/prog/xcel_partidas_act/'.$actividad[0]['act_id'].''; ?>' title="REPORTE CONSOLIDADO DE PARTIDAS DE LA ACTIVIDAD - EXCEL" class="btn btn-primary" style="width:15.5%;">CONSOLIDADO EXCEL</a>
											<hr>
          ...
          <div class="modal-dialog" id="mdialTamanio">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form action="<?php echo site_url().'/prog/valida_insumo_act'?>" id="form_nuevo" name="form_nuevo" class="smart-form" method="post">
                        <input type="hidden" name="act_id" id="act_id" value="<?php echo $actividad[0]['act_id'];?>">
							...
							<fieldset>					
								<div class="row">
									...
									<section class="col col-3">
										...
										<label class="input">
											<i class="icon-append fa fa-tag"></i>
											<input type="text" name="saldo" id="saldo" disabled="true" value="<?php echo $monto_saldo;?>">
										</label>
									</section>
								</div>
	          ...
	          <div class="modal-dialog" id="mdialTamanio">
	            <div class="modal-content">
	              <div class="modal-body">
	                ...
	                <form action="<?php echo site_url().'/prog/valida_update_insumo_act'?>" method="post" id="form_mod" name="form_mod" class="smart-form">
						<input type="hidden" name="proy_id" id="proy_id" value="<?php echo $proyecto[0]['proy_id'];?>">
            ...
            <div class="modal-content">
                <div class="modal-body no-padding">
                    <div class="row">
                       <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="row">
                            <h2 class="row-seperator-header"><i class="glyphicon glyphicon-import"></i> IMPORTAR REQUERIMIENTOS A LA ACTIVIDAD (.CSV) </h2>
                            <div class="col-sm-12">
                              <!-- well -->
                              <div class="well">
                                <!-- row -->
                                <div class="row">
                                  ...
                                  <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                      ...
                                      <form action="<?php echo site_url() . '/insumos/cprog_insumos_directo/importar_requerimientos'?>" enctype="multipart/form-data" id="form_subir_sigep" name="form_subir_sigep" method="post">
                                          <input class="form-control" type="hidden" name="proy_id" value="<?php echo $proyecto[0]['proy_id'];?>">
                                          <input class="form-control" type="hidden" name="act_id" value="<?php echo $actividad[0]['act_id'];?>">
                                          <fieldset>
		...
		<script type="text/javascript">
			...
			alertify.confirm("DESEA ELIMINAR TODOS LOS REQUERIMIENTOS ?", function (a) {
		        if (a) {
		        	window.location='<?php echo base_url().'index.php/prog/delete_ins_a/'.$actividad[0]['act_id'].''?>';
		        } else {
