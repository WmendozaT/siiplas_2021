...
<page backtop="55mm" backbottom="29mm" backleft="10mm" backright="10mm" pagegroup="new">
    <page_header>
                        ...
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td width=80%; align=left>
                            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                                ...
                                <tr style="font-size: 8pt;">
                                    <td style="width:10%; height: 1.5%"><b>UNI. EJEC.</b></td>
                                    <td style="width:90%;">: <?php echo strtoupper($proyecto[0]['dist_distrital']);?></td>
                                </tr>
                                <tr style="font-size: 8pt;">
                                    <td style="height: 1.5%"><b>PROY. DE INV.</b></td>
                                ...
                                <tr style="font-size: 8pt;">
                                    <td style="height: 1.5%"><b>COMPONENTE</b></td>
                                ...
                                <tr style="font-size: 8pt;">
                                    ...
                                    <td>: <?php echo strtoupper($actividad[0]['act_actividad']);?></td>
                                </tr>
                            </table>
                          </td>
                        </tr>
