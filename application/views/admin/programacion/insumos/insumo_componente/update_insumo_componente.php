	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy_poa' ?>" title="MIS OPERACIONES">...</a></li><li>Programaci&oacute;n de Requerimientos - Nivel de Componentes</li><li>Insumo Componente</li><li>Modificar Requerimiento - Activos Fijos</li>
				</ol>
			</div>
			<!-- END RIBBON -->
			<!-- MAIN CONTENT -->
						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				            <section id="widget-grid" class="well">
				                <div class="">
				                  ...
				                  <h1> COMPONENTE : <small><?php echo $dato_com->com_componente?></small>&nbsp;&nbsp;&nbsp;GESTI&Oacute;N : <small><?php echo $gestion;?></small>
				                </div>
				            </section>
				        </article>
				    </div>
						...
						<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false">
								...
								<div>
									...
									<div class="widget-body">
										<div class="row">
											<form action="<?php echo site_url("") . '/insumos/cprog_insumos_delegado/guardar_update_insumo' ?>" id="ins_form_nuevo" name="ins_form_nuevo" novalidate="novalidate" method="post">
			                            	...
			                            	<input type="hidden" name="ins_id" id="ins_id" value="<?php echo $ins_id ?>">
			                            	...
			                            	<input type="hidden" name="gp" id="gp" value="<?php echo $monto_programado;?>"> <!-- ptto gestion -->
															...
															<div class="col-sm-3">
																<div class="form-group">
																	...
																	<div class="input-group">
																		<input type="text" name="ins_fecha" id="ins_fecha" value="<?php echo date('d/m/Y',strtotime($insumo[0]['ins_fecha_requerimiento'])) ?>" placeholder="Seleccione de Requerimiento" class="form-control datepicker"  data-dateformat="dd/mm/yy" title="Seleccione fecha del Requerimiento">
														...
														<div class="row">
															...
															<div class="col-sm-6">
																<div class="form-group"> 
																	...
																	<input name="ins_unidad_medida" id="ins_unidad_medida" class="form-control" maxlength="100" value="<?php echo $insumo[0]['ins_unidad_medida'];?>">
																</div>
															</div>
														</div>
													</div><br>
														...
														<div class="row">
															...
															<div class="col-sm-6">
																<div class="form-group">
																	...
																	<select name="ins_partidas_dependientes" id="ins_partidas_dependientes" class="form-control">
					                                                    <option value="<?php echo $insumo[0]['pid'] ?>" ><?php echo $insumo[0]['cod2'].' - '.$insumo[0]['partida']?></option>  
					                                                </select>
																</div>
															</div>
														</div>
															...
															<div class="col-sm-12">
																<div class="form-group">
																	<label><font size="1"><b>OBSERVACI&Oacute;N </b></font></label>
																		<textarea name="ins_obs" id="ins_obs" rows="2" class="form-control" maxlength="300"><?php echo $insumo[0]['ins_observacion'];?></textarea>
																</div>
															</div>
														</div>
													</div>
												...
												<div id="bootstrap-wizard-1" class="col-sm-3">
													<div class="well">
														<div class="row">
														<?php   $suma=0;
															if(count($insumo_gestion)!=0) /// tiene registrado insumo gestion
															{
																$cont_gest=1;
																foreach ($insumo_gestion as $row) 
	                											{
	                												$insumo_gest = $this->minsumos->get_dato_insumo_gestion($row['insg_id'],$ins_id); //// DATOS DEL INSUMO GESTION
	                												if($row['g_id']==$gestion)
											            			{
											            				?>
											            				<div class="col-sm-12">
										                            		<div class="">
											                            		<div class="row">
												                                    <div class="form-group">
											                                            <LABEL><b><font color="blue">GESTI&Oacute;N <?php echo $row['g_id'];?></font></b></label>
											                                            <input class="form-control" type="hidden" name="insg[]" value="<?php echo $insumo_gest[0]['insg_id'];?>" >
											                                            <input class="form-control" type="text" name="gest[]" id="gestion<?php echo $cont_gest;?>" value="<?php echo $insumo_gest[0]['insg_monto_prog'];?>" onblur="javascript:suma_presupuesto();" autofocus onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false">
											                                        	<input class="form-control" type="hidden" name="gestv<?php echo $cont_gest;?>"  value="<?php echo $row['g_id'];?>">
											                                        </div>
											                                    </div>
										                            		</div>
										                            	</div>
											            			...
											            			else
											            			{
											            				...
											            				<div class="col-sm-12">
										                            		<div class="">
											                            		<div class="row">
												                                    <div class="form-group">
											                                            <LABEL><b>GESTI&Oacute;N <?php echo $row['g_id'];?></b></label>
											                                            <input class="form-control" type="hidden" name="insg[]" value="<?php echo $insumo_gest[0]['insg_id'];?>" >
											                                            <input class="form-control" type="text" name="gest[]" id="gestion<?php echo $cont_gest;?>" value="<?php echo $insumo_gest[0]['insg_monto_prog'];?>" onblur="javascript:suma_presupuesto();" onkeypress="if (this.value.length < 10) { return numerosDecimales(event);}else{return false; }" onpaste="return false">
											                                        	<input class="form-control" type="hidden" name="gestv<?php echo $cont_gest;?>"  value="<?php echo $row['g_id'];?>">
											                                        </div>
											                                    </div>
										                            		</div>
											            			...
											            			$suma=$suma+$insumo_gest[0]['insg_monto_prog'];
											            			$cont_gest++;
	                											}
															}
															else{
											            			...
											            			if($i==$gestion)
											            			{
											            				...
											            				<div class="col-sm-12">
										                            		<div class="">
											                            		<div class="row">
												                                    <div class="form-group">
											                                            <LABEL><b><font color="red">GESTI&Oacute;N <?php echo $i;?></font></b></label>
														...
														<div class="col-sm-12">
						                            		<div class="">
							                                    <div class="form-group">
						                                            ...
						                                            <input type="text" name="suma_monto_total" id="suma_monto_total" class="form-control" value="<?php echo round($suma,2);?>">
						                                        </div>
						                                    </div>
						                            	</div>
						                            	<div class="col-sm-12">
						                            		<div class="">
							                                    <div class="form-group">
						                                            ...
						                                            <input type="text" name="saldo" id="saldo" class="form-control" value="<?php echo round(($insumo[0]['ins_costo_total']-$suma),2);?>">
						                                        </div>
						                                    </div>
						                            	</div>
													</div>
												...
												<div  class="col-sm-12">
													<div class="form-actions">
														...
														<input type="button" value="MODIFICAR REQUERIMIENTO" id="btsubmit" class="btn btn-primary btn-lg" onclick="valida_envia()" title="MODIFICAR REQUERIMIENTO">
													</div>
												</div>
											</form>
										</div>
