	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				<!-- breadcrumb -->
				<ol class="breadcrumb">
					<li>...</li><li>Programaci&oacute;n</a></li><li>Requerimientos</li><li><?php if($proyecto[0]['tp_id']==1){echo "Componente";}else{echo "Servicio";}?></li>
				</ol>
			</div>
			<!-- END RIBBON -->
					...
					<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<section id="widget-grid" class="well">
							<ul class="nav nav-pills">
							  <li class="active"><a href="#"><?php if($proyecto[0]['tp_id']==1){echo "COMPONENTES";}else{echo "SERVICIOS, SUB ACTIVIDADES";}?></a></li>
				...
				<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0" data-widget-editbutton="false">
						<header>
							...
							<h2><?php if($proyecto[0]['tp_id']==1){echo "MIS OPERACIONES";}else{echo "MIS SERVICIOS";}?></h2>
						</header>
						<!-- widget div-->
						<div>
							<!-- widget edit box -->
