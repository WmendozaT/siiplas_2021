    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mis Operaciones</li><li>Programaci&oacute;n de Operaciones</li><li>Operaciones Aprobadas</li><li>Ponderaci&oacute;n de Productos</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                            <section id="widget-grid" class="well">
                                <div class="">
                                    ...
                                    <h1> PROCESO : <small><?php echo $componente[0]['com_componente']?></small>
                                </div>
                            </section>
                        </article>
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                            <section id="widget-grid" class="well">
                              <a href="<?php echo base_url().'index.php/proy/pcion_comp/'.$proyecto[0]['proy_id'].'' ?>"  class="btn btn-success" title="VOLVER ATRAS" style="width:100%;">ATRAS</a> 
                            </section>
                        </article>
                    </div>
                    <div class="row">    
