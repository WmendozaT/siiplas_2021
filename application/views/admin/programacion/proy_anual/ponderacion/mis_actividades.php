    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mis Operaciones</li><li>Programaci&oacute;n de Operaciones</li><li>Operaciones Aprobadas</li><li>Ponderaci&oacute;n de Actividades</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <section id="widget-grid" class="">
                    <div class="row">
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                            <section id="widget-grid" class="well">
                                <div class="">
                                    ...
                                    <h1> CATEGORIA PROGRAM&Aacute;TICA : <small><?php echo $proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['proy_nombre']?></small></h1>
                                    <h1> PROCESO : <small><?php echo $componente[0]['com_componente']?></small></h1>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                            <section id="widget-grid" class="well">
                              <a href="<?php echo base_url().'index.php/proy/pcion_prod/'.$componente[0]['com_id'].'' ?>" class="btn btn-success" title="VOLVER ATRAS" style="width:100%;">ATRAS</a> 
                            </section>
                        </article>
                    </div>
                    <div class="row">
            ...
            $(function () {
                ...
                $("#ponderar").on("click", function () {
                    ...
                    if (!$valid) {
                        ...
                        alertify.confirm("PONDERAR ACTIVIDADES ?", function (a) {
                            if (a) {
