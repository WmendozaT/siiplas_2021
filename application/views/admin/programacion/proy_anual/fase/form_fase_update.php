		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<ol class="breadcrumb">
					<?php
					if($proyecto[0]['proy_estado']==1){ ?>
						<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy#tabs-a'?>" title="MIS PROYECTOS DE INVERSI&Oacute;N">Programaci&oacute;n de Proyectos</a></li><li><a href="<?php echo base_url().'index.php/admin/proy/list_proy'?>">T&eacute;cnico de Unidad Ejecutora</a></li><li>Fases del Proyecto de Inversi&oacute;n (Modificar)</li>
						<?php
					}
					elseif ($proyecto[0]['proy_estado']==2){ ?>
						<li><a href="<?php echo base_url().'index.php/admin/proy/list_proy_poa#tabs-a'?>" title="MIS PROYECTOS DE INVERSI&Oacute;N">Programaci&oacute;n de Proyectos</a></li><li><a href="<?php echo base_url().'index.php/admin/proy/list_proy'?>">T&eacute;cnico Analista POA</a></li><li>Fases del Proyecto de Inversi&oacute;n (Modificar)</li>
						<?php }
					?>
				</ol>
			</div>
						...
						<article class="col-sm-12">
			                ...
			                <?php }
			                  elseif($this->session->flashdata('danger')){ ?>
			                    ...
			                    <?php }
			                ?>
							<form id="formulario" name="formulario" method="post" action="<?php echo site_url("").'/programacion/faseetapa/update_fase_etapa'?>">
							<input class="form-control" type="hidden" name="pfec_id" value="<?php echo $fase_proyecto[0]['id']?>">
									...
									<div class="widget-body">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="well">
													<fieldset>
														<section>
															<label class="label" id="col"><b>FASE <?php echo $fase_proyecto[0]['fas_id'];?><font color="red">(*)</font></b></label>
								                                <select name="fase" id="fase" class="form-control" title="SELECCIONE FASE">
																	<option value="">SELECCIONE  FASE</option>
                                                     				<?php 
												                    foreach($fase as $row){
												                    	if($row['fas_id']==$fase_proyecto[0]['fas_id']){ ?>
														                     <option value="<?php echo $row['fas_id']; ?>" selected><?php echo strtoupper($row['fas_fase']);?></option>
														                    <?php 
												                    	}
												                    	else{ ?>
														...
														<section>
															<label class="label" id="col"><b>ETAPA <font color="red">(*)</font></b></label>
														...
														<section>
															<label class="label" id="col"><b>EJECUCI&Oacute;N <font color="red">(*)</font></b></label>
														...
														<div id="fa">
															<section>
																<label class="label" id="col"><b>DESCRIPCI&Oacute;N FASE <font color="red">(*)</font></b></label>
									                            <textarea rows="4" name="desc" id="desc" class="form-control" style="width:100%;" maxlength="200"><?php echo $fase_proyecto[0]['descripcion'] ?></textarea> 
															</section>
														</div>
													</fieldset>
												</div>
											...
											<div class="col-sm-6">
												<div class="well">
													<fieldset>
														<section>
															<label class="label" id="col"><b>FECHA INICIO FASE <font color="red">(*)</font></b></label>
								                                <div class="input-group">
																	<input type="text" name="f_inicio" id="f_inicio" placeholder="Seleccione Fecha inicial"  class="form-control datepicker" data-dateformat="dd/mm/yy" value="<?php echo date('d/m/Y',strtotime($fase_proyecto[0]['inicio'])) ?>"">
																	<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																</div>
														</section><br>

														<section>
															<label class="label" id="col"><b>FECHA FINAL FASE <font color="red">(*)</font></b></label>
																<div class="input-group">
																	<input type="text" name="f_final" id="f_final" placeholder="Seleccione Fecha final" class="form-control datepicker" data-dateformat="dd/mm/yy" value="<?php echo date('d/m/Y',strtotime($fase_proyecto[0]['final'])) ?>"">
																	<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
																</div>
															</label>
														</section><br>
														<section>
															<label class="label" id="col"><b>PRESUPUESTO PROGRAMADO FASE <font color="red">(*)</font></b></label>
																<input class="form-control" type="text" name="monto_total" id="monto_total" value="<?php echo round($fase_proyecto[0]['pfec_ptto_fase'],3) ?>" placeholder="0" onkeypress="if (this.value.length < 15) { return numerosDecimales(event);}else{return false; }" onpaste="return false">
															</label>
														</section><br>
														<section>
															<label class="label" id="col"><b>PRESUPUESTO EJECUTADO FASE </b></label>
																<input class="form-control" type="text"  value="<?php echo round($fase_proyecto[0]['pfec_ptto_fase_e'],3) ?>"  placeholder="0"  disabled="true">
															</label>
														</section><br>
														<?php /// verificando la gestion actual faseetapa
														if($nro_fg!=0 & $nro_fg_act==1){ ?>
														<section>
															<label class="label" id="col"><b>PRESUPUESTO GESTI&Oacute;N <?php echo $this->session->userdata('gestion')?> </b></label>
																<input class="form-control" type="text"  value="<?php echo round($f_gest[0]['pfecg_ppto_total'],3) ?>"   placeholder="0"  disabled="true">
															</label>
														</section>
															<?php }
														?>
										...
										<div class="col-sm-12">
											<div id="but" align="right">
												...
												<input type="button" value="MODIFICAR DATOS FASE Y MODIFICAR PRESUPUESTO" id="btsubmit" class="btn btn-primary" title="MODIFICAR DATOS DE LA FASE"><br><br>
											</div>
										</div>
									</div>
								</div>
		...
		$(function () {
		    $("#btsubmit").on("click", function (e) {
		        ...
		        if (!$valid) {
		        	...
		        	reset();
	                alertify.confirm("MODIFICAR DATOS DE LA FASE Y PROGRAMAR PRESUPUESTO POR GESTIONES ?", function (a) {
	                    if (a) {
