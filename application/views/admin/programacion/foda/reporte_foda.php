...
<page backtop="75mm" backbottom="33mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
...
try{
    ...
    $html2pdf->Output('FORM SPO N 3-'.$proyecto[0]['dep_sigla'].'-'.$proyecto[0]['tipo'].' '.$proyecto[0]['act_descripcion'].'.pdf');
}
