    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Evaluaci&oacute;n POA</li><li>Mis Poas Aprobados</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                    ...
                    <div class="row">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="well well-sm well-light">
                                <h2 class="alert alert-success"><center>EVALUACI&Oacute;N POA - <?php echo $this->session->userData('gestion');?></center></h2>
                                <div id="tabs">
                                    <ul>
                                        <li>
                                                            ...
                                                            <table id="dt_basic3" class="table table-bordered" style="width:100%;" font-size: "7px";>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th bgcolor="#474544">TIPO</th>
                                                                        <th bgcolor="#474544">RESPONSABLE (UE)</th>
                                                                        <th bgcolor="#474544">UNIDAD ADMINISTRATIVA</th>
                                                                        <th bgcolor="#474544">UNIDAD EJECUTORA</th>
                                                                        <th bgcolor="#474544">PRESUPUESTO ASIGNADO <?php echo $this->session->userdata('gestion')?></th>
                                                                        <th bgcolor="#474544">PRESUPUESTO PROGRAMADO <?php echo $this->session->userdata('gestion')?></th>
                                                                        <th bgcolor="#474544">REPORTE</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                <?php echo $operacion;?>
                                                            ...
                                                            <table id="dt_basic1" class="table table-bordered" style="width:100%;" font-size: "7px";>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th bgcolor="#474544"></th>
                                                                        <th bgcolor="#474544">CATEGORIA PROGRAM&Aacute;TICA <?php echo $this->session->userdata("gestion");?></th>
                                                                        <th bgcolor="#474544">PROYECTO DE INVERSI&Oacute;N</th>
                                                                        <th bgcolor="#474544">TIPO</th>
                                                                        <th bgcolor="#474544">RESPONSABLE (UE)</th>
                                                                        <th bgcolor="#474544">UNIDAD ADMINISTRATIVA</th>
                                                                        <th bgcolor="#474544">UNIDAD EJECUTORA</th>
        ...
        <script type="text/javascript">
            $(function () {
                $(".enlace").on("click", function (e) {
                    ...
                    var url = "<?php echo site_url("")?>/ejecucion/cevaluacion/get_poa";
                    var request;
                    if (request) {
                        request.abort();
                    }
