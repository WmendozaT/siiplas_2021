    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Registro de Evaluaci&oacute;n</li><li>Evaluaci&oacute;n POA</li><li>Mis Actividades</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
               ...
               <!--  <input type="hidden" name="mtotal_prog" id="mtotal_prog"> -->
        ...
        $(function () {
            ...
            $(".add_ff").on("click", function (e) {
                ...
                request = $.ajax({
                    ...
                    type: "POST",
                    dataType: 'json',
                    data: "prod_id="+prod_id+"&proy_id="+proy_id
                });
