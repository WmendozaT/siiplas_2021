...
<page backtop="46mm" backbottom="35mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
        ...
        <div align="center">EVALUACI&Oacute;N POA - <?php echo $this->session->userdata('gestion')?></div><br>
    </page_header>
    <page_footer>
        <hr>
