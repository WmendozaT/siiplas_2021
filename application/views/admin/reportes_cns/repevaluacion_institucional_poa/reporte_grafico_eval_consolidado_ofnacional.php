...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <style type="text/css">
      ...
      #areaImprimir_efi{display:none}
      @media print {
          #areaImprimir_efi {display:block}
      }
      table{font-size: 9px;
      width: 100%;
      max-width:1550px;
                ...
                <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                    <header>
                        ...
                        <ul class="nav nav-tabs pull-right in" id="myTab">
                            ...
                            <li>
                                <a data-toggle="tab" href="#s2"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">UNIDADES DEPENDIENTES</span></a>
                            </li>
                            <li>
                                        ...
                                        <hr>
                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                  ...
                                                  <div style="font-size: 12px;font-family: Arial; height: 2.5%;"><b>(%) EFICIENCIA (Economia/Eficacia)</b></div>
                                                  <table border="1" style="width:100%;" align="center">
                                                      <tr>
