    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Reportes</li><li>Partidas</li><li>Cuadro Comparativo por Partidas a Nivel de Acciones Operativas</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                    ...
                    <nav role="navigation" class="navbar navbar-default navbar-inverse">
                        ...
                        <div id="navbarCollapse" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href='#' title="ACCIONES DEL PROGRAMA : <?php echo $programa[0]['aper_programa'].' '.$programa[0]['aper_proyecto'].' '.$programa[0]['aper_actividad']; ?>"><i class="glyphicon glyphicon-ok"></i> ACCIONES OPERATIVAS</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
                            <section id="widget-grid" class="well">
                                <div class="">
                                    <h1>CUADRO COMPARATIVO POR PARTIDAS A NIVEL DE ACCIONES OPERATIVAS</h1>
                                </div>
                            </section>
                        </article>
                                                        ...
                                                        <table id="dt_basic" class="table table-bordered" style="width:100%;" font-size: "7px";>
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th bgcolor="#474544">OBSERVACI&Oacute;N</th>
