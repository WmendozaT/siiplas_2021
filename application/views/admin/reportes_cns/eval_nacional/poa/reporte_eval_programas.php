...
<page backtop="48mm" backbottom="40mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
        ...
        <div align="center" style="font-size: 11pt;"><b>REPORTE INSTITUCIONAL CONSOLIDADO DE EVALUACI&Oacute;N DE OPERACIONES POR CATEGORIA PROGRAM&Aacute;TICA - <?php echo $this->session->userdata('gestion')?></b></div><br>
    </page_header>
    <page_footer>
      <hr>
