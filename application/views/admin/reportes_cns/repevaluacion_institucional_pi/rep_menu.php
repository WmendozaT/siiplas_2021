    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                   <li>Reportes POA</li><li>Evaluaci&oacute;n poa</li><li>Proyecto de Inversi&oacute;n</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
                <div id="content">
                ...
                <section id="widget-grid" class="">
                    ...
                    <h2 class="alert alert-success"><center>EVALUACI&Oacute;N PROYECTOS DE INVERSI&Oacute;N - GESTI&Oacute;N <?php echo $this->session->userData('gestion');?></center></h2>
                    <div class="row">
                        <?php echo $regional;?>
                    </div>
                </section>
        ...
        <script type="text/javascript">
            $(function () {
                $(".enlace").on("click", function (e) {
                    ...
                    var url = "<?php echo site_url("")?>/reporte_evaluacion/crep_evalinstitucionalpi/get_cuadro_evaluacion_institucional";
                    var request;
                    if (request) {
                        request.abort();
                    }
