                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1" title="EFICACIA INSTITUCIONAL A NIVEL UNIDAD">
                                                ...
                                                <hr>
                                                <h2 class="alert alert-success" align="center"><?php echo $proyecto[0]['aper_programa'].''.$proyecto[0]['aper_proyecto'].''.$proyecto[0]['aper_actividad'].' - '.$proyecto[0]['proy_nombre']?><br><b><?php echo $tmes[0]['trm_descripcion'];?></b></h2>
                                                <div class="row">
        ...
        <script type="text/javascript">
          ...
          $(document).ready(function() {
            chart1 = new Highcharts.Chart({
              ...
              title: {
                text: '<?php echo 'ACUMULADO GESTIÓN : '.$this->session->userData('gestion') ;?>'
              },
              subtitle: {
                text: ''
              },
        ...
        <script type="text/javascript">
          ...
          $(document).ready(function() {
            chart1 = new Highcharts.Chart({
              ...
              title: {
                text: '<?php echo 'ACUMULADO AL '.$tmes[0]['trm_descripcion'];?>'
              },
              subtitle: {
                text: ''
              },
