...
<html lang="en-us">
    ...
    <body class="">
            ...
            <nav>
                <ul>
                    ...
                    <li class="text-center">
                        <a href="#" title="EVALUACI&Oacute;N DISTRITAL"> <span class="menu-item-parent">REPORTES</span></a>
                    </li>
                    <?php echo $menu;?>
                </ul>
            </nav>
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Reportes</li><li>Reporte Evaluaci&oacute;n Distrital</li><li>Distrital <?php echo strtoupper($dist[0]['dist_distrital']);?></li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                        ...
                        <article class="col-sm-12">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                                <header>
                                    ...
                                    <h2>EVALUACI&Oacute;N DISTRITAL <?php echo strtoupper($dist[0]['dist_distrital']);?></h2>

                                    <ul class="nav nav-tabs pull-right in" id="myTab">
                                        <li class="active">
                                            <a data-toggle="tab" href="#s1"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">CUADRO DE EJECUCI&Oacute;N DISTRITAL</span></a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#s2"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">CUADRO EFICACIA POR PROGRAMAS</span></a>
                                        </li>
                                       <!--  <li>
                                            <a data-toggle="tab" href="#s3"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">PARAMETROS DE EFICACIA</span></a>
                                        </li> -->
                                        <li>
                                            <a data-toggle="tab" href="#s4"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">LISTA DE UNIDADES - PROYECTOS DE INVERSI&Oacute;N</span></a>
                                        </li>
                                        <!-- <li>
                                            <a data-toggle="tab" href="#s5"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">PROGRAMADO</span></a>
                                        </li>

                                        <li>
                                            <a data-toggle="tab" href="#s6"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">EJECUTADO</span></a>
                                        </li> -->
                                    </ul>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1" title="EFICACIA INSTITUCIONAL A NIVEL DISTRITAL">
                                                <hr>
                                                    <div align="right">
                                                        <a href="#" onclick="printDiv('areaImprimir')" title="IMPRIMIR CUADRO DE EFICACIA DISTRITAL" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/printer.PNG" WIDTH="20" HEIGHT="20"/>&nbsp;IMPRIMIR CUADRO DE EFICACIA DISTRITAL</a>&nbsp;&nbsp;
                                                ...
                                                <hr>
                                                <h2 class="alert alert-success" align="center">EJECUCI&Oacute;N A NIVEL DE LA <?php echo strtoupper($dist[0]['dist_distrital']); ?> </h2>
                                                <div class="row">
                                                <?php
                                            ...
                                            <!-- end s1 tab pane -->
                                            <div class="tab-pane fade" id="s2" title="CUADRO EFICACIA DE OPERACIONES POR CATEGORIA PROGRAMÁTICA">
                                                <hr>
                                                    <div align="right">
                                                        <a href="#" onclick="printDiv('areaImprimir_eval')" title="IMPRIMIR CUADRO DE EVALUACIÓN POR PROGRAMAS" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/printer.png" WIDTH="20" HEIGHT="20"/>&nbsp;IMPRIMIR EVALUACI&Oacute;N POR PROGRAMAS</a>&nbsp;&nbsp;
                                                        <a href="<?php echo base_url();?>index.php/regionales" title="SALIR A LISTA DE REGIONALES" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/arrow_turn_left.png" WIDTH="20" HEIGHT="20"/>&nbsp;SALIR</a>
                                                    </div>
                                                <hr>
                                                <div class="row">
                                            ...
                                            <!-- end s2 tab pane -->
                                            <div class="tab-pane fade" id="s4" title="EVALUACI&Oacute;N DE UNIDADES">
                                                <div class="row">
                                                    <hr>
                                                        <div align="right">
                                                            <a href="javascript:abreVentana('<?php echo site_url("").'/print_rep_distrital/'.$dist[0]['dist_id'];?>');" title="REPORTE DE EVALUACI&Oacute;N DE UNIDADES-PROYECTOS DE INVERSI&Oacute;N" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/printer.png" WIDTH="20" HEIGHT="20"/>&nbsp;IMPRIMIR EVALUACI&Oacute;N DE UNIDADES</a>&nbsp;&nbsp;
                                                            <a href="<?php echo base_url();?>index.php/regionales" title="SALIR A LISTA DE REGIONALES" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/arrow_turn_left.png" WIDTH="20" HEIGHT="20"/>&nbsp;SALIR</a>
                                                        </div>
                                                    <hr>
                                                    <h2 class="alert alert-success" align="center">UNIDADES, PROYECTOS DE INVERSI&Oacute;N - <?php echo strtoupper($dist[0]['dist_distrital']); ?> </h2>
                                                    <div class="table-responsive">
                                                        <h1 class="page-title txt-color-blueDark"> El siguiente cuadro muestra la evaluaci&oacute;n Acumulada de Operaciones por cada Unidad/Proyecto de Inversi&oacute;n al <?php echo $trimestre[0]['trm_descripcion'];?></h1>
                                                        <?php echo $list_acciones;?>
                                                        <hr>
                                                            <?php echo $pie;?>
                                                        <hr>
                                                    </div>
    ...
    <!-- ========================================================================================================= -->
        ...
        <div id="areaImprimir_eval">
            <?php echo $eval_distrital;?>
        </div>
        <!-- <div id="areaImprimir_eficacia">
