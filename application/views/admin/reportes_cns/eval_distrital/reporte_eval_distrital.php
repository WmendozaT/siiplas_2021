...
<page backtop="46mm" backbottom="40mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                          ...
                          <td width=60%; align=left>
                            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                                ...
                                <tr style="font-size: 8pt;">
                                    ...
                                    <td style="width:80%;"><?php echo strtoupper($dist[0]['dep_departamento']); ?></td>
                                </tr>
                                <tr style="font-size: 8pt;">
                                    <td height: 1.2%"><b>DISTRITAL : </b></td>
                                    <td><?php echo strtoupper($dist[0]['dist_distrital']); ?></td>
                                </tr>
                            </table>
                          </td>
        ...
        <div align="center" style="font-size: 10px;">EVALUACI&Oacute;N ACUMULADA DE OPERACIONES POR UNIDADES/PROYECTOS HASTA EL <?php echo $trimestre[0]['trm_descripcion'];?> - <?php echo $this->session->userdata('gestion')?></div><br>
    </page_header>
    <page_footer>
        <hr>
            ...
            <tr>
                <td colspan=3>
                  <table border="0" style="width:100%;">
                    <tr>
                      <td style="width:25%;">
                        <div class="circulo1" style="width:99%;" align="center"><br>
                          &nbsp;<b>INSATISFACTORIO (0 a 99)% <br> <?php echo $nro[1];?> Unidades</b>
                        </div>
                      </td>
                      <td style="width:25%;">
                        <div class="circulo2" style="width:99%;" align="center"><br>
                          &nbsp;<b>REGULAR (75 a 90)% <br> <?php echo $nro[2];?> Unidades</b>
                        </div>
                      </td>
                      <td style="width:25%;">
                        <div class="circulo3" style="width:99%;" align="center"><br>
                          &nbsp;<b>BUENO (90 a 99)% <br> <?php echo $nro[3];?> Unidades</b>
                        </div>
                      </td>
                      <td style="width:25%;">
                        <div class="circulo4" style="width:99%;" align="center"><br>
                          &nbsp;<b>OPTIMO 100% <br> <?php echo $nro[4];?> Unidades</b>
                        </div>
                      </td>
                    </tr>
                  </table>
