    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Reportes</li><li>Reporte Evaluaci&oacute;n Regional</li><li><b>CONSOLIDADO REGIONAL <?php echo strtoupper($dep[0]['dep_departamento']);?></b></li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                        ...
                        <article class="col-sm-12">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                                <header>
                                    ...
                                    <h2>CONSOLIDADO REGIONAL <?php echo strtoupper($dep[0]['dep_departamento']); ?></h2>

                                    <ul class="nav nav-tabs pull-right in" id="myTab">
                                        <li class="active">
                                            <a data-toggle="tab" href="#s1"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">CUADRO DE EJECUCI&Oacute;N DE OPERACIONES</span></a>
                                        </li>
                                        <li>
                                            <a data-toggle="tab" href="#s2"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">CUADRO EFICACIA DE OPERACIONES</span></a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="widget-body">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div class="tab-pane fade active in padding-10 no-padding-bottom" id="s1" title="EFICACIA INSTITUCIONAL A NIVEL REGIONAL">
                                                <hr>
                                                    <div align="right">
                                                        <a href="#" onclick="printDiv('areaImprimir')" title="IMPRIMIR CUADRO DE EFICACIA DE LA REGI&Oacute;N" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/printer.png" WIDTH="20" HEIGHT="20"/>&nbsp;IMPRIMIR CUADRO DE EFICACIA</a>&nbsp;&nbsp;
                                                        <a href="#" data-toggle="modal" data-target="#modal_mod_ff" class="btn btn-default mod_ff" name="<?php echo $dep[0]['dep_id'];?>" title="EJECUCION TRIMESTRAL"style="width:15.5%;"> <img src="<?php echo base_url(); ?>assets/Iconos/application.png" WIDTH="20" HEIGHT="20"/>&nbsp;CUADRO DE EJECUCI&Oacute;N TRIMESTRAL</a>
                                                ...
                                                <hr>
                                                <h2 class="alert alert-info" align="center">CUADRO DE EJECUCI&Oacute;N DE RESULTADOS AL <?php echo $trimestre[0]['trm_descripcion'];?> - <?php echo strtoupper($dep[0]['dep_departamento']);?></h2>
                                                <div class="row">
                                                <?php
                                                    if($this->session->userdata('trimestre')==1 || $this->session->userdata('trimestre')==2){ ?>
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <div class="well padding-10">
                                                                <div id="regresion" style="width: 900px; height: 400px; margin: 0 auto"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                            <div class="well padding-10">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <div class="well padding-12">
                                                                <div id="regresion" style="width: 1500px; height: 450px; margin: 0 auto"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <hr>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                            <div class="well padding-12">
                                                                <div id="container" style="width: 1500px; height: 450px; margin: 0 auto"></div>
                                                            </div>
                                                        </div>
                                                        <?php
                                                    }
                                            ...
                                            <div class="tab-pane fade" id="s2" title="CUADRO CONSOLIDADO EVALUACIÓN REGIONAL">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <hr>
                                                        <h2 class="alert alert-info" align="center">EFICACIA DE OPERACIONES POR CATEGORIA PROGR&Aacute;MATICA</h2>
                                            ...
                                            <div class="tab-pane fade" id="s4" title="CUADRO PARAMETRO DE EFICACIA - REGIONAL">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                       <hr>
                                                            <div align="right">
                                                                <a href="#" onclick="printDiv('areaImprimir_efi')" title="IMPRIMIR CUADRO DE EFICACIA DE LA REGI&Oacute;N" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/printer.png" WIDTH="20" HEIGHT="20"/>&nbsp;IMPRIMIR CUADRO DE PARAMETROS DE EFICACIA</a>&nbsp;&nbsp;
                                                                <a href="<?php echo base_url();?>index.php/regionales" title="SALIR A LISTA DE REGIONALES" class="btn btn-default"><img src="<?php echo base_url(); ?>assets/Iconos/arrow_turn_left.png" WIDTH="20" HEIGHT="20"/>&nbsp;SALIR</a>&nbsp;&nbsp;
                                                            </div>
                                                        <hr>
                                                        <h2 class="alert alert-info" align="center">CUADRO NIVEL DE EJECUCI&Oacute;N DE UNIDADES/PROYECTOS DE INVERSI&Oacute;N</h2>
                ...
                <div class="modal-content">
                  <div class="modal-body">
                    ...
                    <form class="smart-form">
                        <header><b><?php echo "REGIONAL - ".strtoupper($dep[0]['dep_departamento']);?></b>
                            <br><label class="label">CUADRO DE EJECUCI&Oacute;N DE RESULTADOS AL <?php echo $trimestre[0]['trm_descripcion'];?></label>
                        </header>
                        <fieldset>                  
                            <div class="row">
                                <div class="table-responsive">
                                    <label class="label">EJECUCI&Oacute;N ACUMULADA A LA META ANUAL</label>
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th></th>
                                ...
                                <div class="">
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7" >
                                        <h1 class="page-title txt-color-blueDark" style="background-color: #4e5050; height: 25px; padding: 4px; border-radius: 5px;"><font color=#fff>CALIFICACI&Oacute;N AL <?php echo $trimestre[0]['trm_descripcion'];?> META ANUAL &nbsp;&nbsp;:&nbsp;&nbsp;  
                                            <b><?php echo $tabla[3][$tr];?>%</b></font>
                                        </h1>
                                    </div>
                                </div>
                        ...
                        <div id="mbut">
                            <footer>
                                <button type="button" name="subir_mins" id="subir_mins" class="btn btn-info" >IMPRIMIR EJECUCI&Oacute;N</button>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $(".mod_ff").on("click", function (e) {
                    ...
                    $('#content1').html('<div class="loading" align="center"><img src="<?php echo base_url() ?>/assets/img_v1.1/preloader.gif" alt="loading" /><br/>Un momento por favor, Actualizando datos de ejecución...</div>');
                    var url = "<?php echo site_url("")?>/reportes_cns/crep_evalrtrimestre/get_ejecutado_trimestre";
                    var request;
                    if (request) {
                        request.abort();
                    }
