    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Reportes</li><li>Reporte Evaluaci&oacute;n Regional</li><li><b>CONSOLIDADO REGIONAL <?php echo strtoupper($dep[0]['dep_departamento']);?> - PEI</b></li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                            ...
                            <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                                <header>
                                    ...
                                    <ul class="nav nav-tabs pull-right in" id="myTab">
                                        <li class="active">
                                            <a data-toggle="tab" href="#s1"><i class="fa fa-clock-o"></i> <span class="hidden-mobile hidden-tablet">OBJETIVOS ESTRATEGICOS</span></a>
                                        </li>
                                    </ul>
                                </header>
