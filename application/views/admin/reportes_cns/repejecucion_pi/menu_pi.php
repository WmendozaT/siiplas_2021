    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Reportes POA</li><li>Ejecución Proyectos de Inversión</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
            ...
            <div class="modal fade" id="modal_operaciones" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog" id="mdialTamanio">
                    <div class="modal-content">
                        ...
                        <h2 class="alert alert-info"><center>SEGUIMIENTO A PROYECTOS DE INVERSIÓN - <?php echo $this->session->userData('gestion');?></center></h2>
                            <div class="row">
