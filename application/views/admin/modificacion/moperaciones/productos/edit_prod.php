								...
								<div>
									...
									<div class="col-sm-12">
										<div id="but" align="right">
											...
											<input type="button" value="MODIFICAR DATOS OPERACIÓN" id="btsubmit" class="btn btn-primary" title="GUARDAR DATOS OPERACION"><br><br>
										</div>
									</div>
								</div>
							</div>
		...
		$(function () {
		    $("#btsubmit").on("click", function (e) {
		        var $validator = $("#formulario").validate({
		            ...
		            messages: {
		                prod: {required: "<font color=red size=1>REGISTRE DATOS DE LA OPERACIÓN</font>"},
		                ...
		                met: {required: "<font color=red size=1>REGISTRE META DE LA OPERACIÓN</font>"}
		            },
		        ...
		        if (!$valid) {
		        	...
		        	if(document.formulario.tp_id.value==1){
		        		...
		        		if(document.formulario.tp_id.value==1){
		        			if(parseFloat(meta)!=(parseFloat(total)+parseFloat(linea))){
		        				alertify.error("LA SUMA DE MESES PROGRAMADOS NO ES IGUAL A LA META DE LA OPERACIÓN") 
		        	...
		        	reset();
	                alertify.confirm("GUARDAR DATOS DE LA OPERACIÓN?", function (a) {
	                    if (a) {
