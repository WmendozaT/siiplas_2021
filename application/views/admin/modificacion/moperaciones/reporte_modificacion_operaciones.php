...
<page backtop="49mm" backbottom="49.5mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:91.8%;">
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                          ...
                          <td style="width:19%; font-size: 8.5px;" align="left">
                            <b style="font-size: 11.5px;">CÓDIGO N°: <?php if($cite[0]['cite_estado']==0){echo " ---------";}else{echo $cite[0]['cite_codigo'];} ?></b><br>
        ...
        <div align="center" style="font-size: 15pt;"><b>MODIFICACI&Oacute;N DE ACTIVIDADES <?php echo $this->session->userdata('gestion')?></b></div>
    </page_header>
    <page_footer>
