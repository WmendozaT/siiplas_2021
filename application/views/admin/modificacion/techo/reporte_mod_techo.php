...
<page backtop="53mm" backbottom="27mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                          ...
                          <td width=87%; align=left>
                            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                                ...
                                <tr style="font-size: 8pt;">
                                    ...
                                    <td style="width:90%;">: <?php echo strtoupper($cite[0]['cppto_cite']);?> || <b>FECHA : </b><?php echo date('d/m/Y',strtotime($cite[0]['cppto_fecha']));?></td>
                                </tr>
                            </table>
                          </td>
                        </tr>
        ...
        <div align="center">MODIFICACI&Oacute;N DEL TECHO PRESUPUESTARIO <?php echo $this->session->userdata('gestion')?></div><br>
    </page_header>
    <page_footer>
        <hr>
            ...
            <tr>
                <td style="width: 33%;">
                    <table border="1" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                        <tr>
                            <td style="width:100%;"><b>JEFATURA DE UNIDAD O AREA / REP. DE AREA REGIONALES<br>.</b></td>
                        </tr>
                        <tr>
