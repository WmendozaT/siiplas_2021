    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Evaluaci&oacute;n POA</li><li>....</li><li>Mis Certificaciones POA</li><li>Mis POAS Aprobados</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                    ...
                    <div class="row">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="well well-sm well-light">
                                <h2 class="alert alert-success"><center>GENERAR CERTIFICACI&Oacute;N POA - <?php echo $this->session->userData('gestion');?></center></h2>
                                <div id="tabs">
                                    <ul>
                                        <li>
        ...
        <script type="text/javascript">
            $(function () {
                $(".enlace").on("click", function (e) {
                    ...
                    var url = "<?php echo site_url("")?>/ejecucion/ccertificacion_poa/get_actividades";
                    var request;
                    if (request) {
                        request.abort();
                    }
