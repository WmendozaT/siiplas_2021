...
ob_start();
$msg = $cpoa[0]['cpoa_codigo']." - RESPONSABLE:".$cpoa[0]['fun_nombre']." - NRO.ITEMS:".$nro."";
                            ...
                            <td style="width:60%;">
                                <table border="0" style="width:100%;">
                                    <tr style="font-size: 8.5px;font-family: Arial; height: : 30;">
                                        <td style="width:28%;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PROGRAMA</b></td>
                                        <td style="width:72%;">: <?php echo $programa[0]['aper_programa'].''.$programa[0]['aper_proyecto'].''.$programa[0]['aper_actividad'].' - '.$programa[0]['aper_descripcion'];?></td>
                                    </tr>
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OBJETIVO ESTRATEGICO</b></td>
                                        <td style="width:72%;">: <?php echo $datos[0]['obj_codigo'].'.- '.$datos[0]['obj_descripcion'];?></td>
                                    </tr>
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OBJETIVO GESTI&Oacute;N</b></td>
                                        <td style="width:72%;">: <?php echo $datos[0]['or_codigo'].'.- '.$datos[0]['or_objetivo'];?></td>
                                    </tr>
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OPERACI&Oacute;N</b></td>
                                        <td style="width:72%;">: <?php echo $datos[0]['prod_cod'].'.- '.$datos[0]['prod_producto'];?></td>
                                    </tr>
                                </table>
                            </td>
                            <td style="width:40%;">
                                <table border="0" style="width:100%;">
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b>DIR. ADM.</b></td>
                                        <td style="width:72%;">: <?php echo strtoupper($datos[0]['dep_departamento']);?></td>
                                    </tr>
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b>UNI. EJEC.</b></td>
                                        <td style="width:72%;">: <?php echo strtoupper($datos[0]['dist_distrital']);?></td>
                                    </tr>
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                    <?php
                                        if($datos[0]['tp_id']==1){ ?>
                                        <td style="width:28%;"><b>PROYECTO </b></td>
                                        <td style="width:72%;">: <?php echo $datos[0]['aper_programa'].''.$datos[0]['proy_sisin'].''.$datos[0]['aper_actividad'].' - '.$datos[0]['proy_nombre'];?></td>
                                            <?php
                                        }
                                        else{ ?>
                                            <td style="width:28%;"><b>ACTIVIDAD</b></td>
                                            <td style="width:72%;">: <?php echo $datos[0]['aper_programa'].''.$datos[0]['aper_proyecto'].''.$datos[0]['aper_actividad'].' '.$datos[0]['tipo'].' - '.strtoupper($datos[0]['act_descripcion']).' '.$datos[0]['abrev'];?></td>
                                            <?php
                                    ...
                                    <tr style="font-size: 8.5px;font-family: Arial;">
                                        <td style="width:28%;"><b><?php if($datos[0]['tp_id']==1){echo "UNIDAD RESPONSABLE ";}else{echo "SUBACTIVIDAD ";} ?></b></td>
                                        <td style="width:72%;">: <?php echo $datos[0]['serv_cod'].' '.$datos[0]['tipo_subactividad'].' '.$datos[0]['serv_descripcion'];?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
