...
<div id="sidebar" class="sidebar">
  ...
  <ul >
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_SOL_POA_5_2025.xlsx" download  title="FORMULARIO DE CERTIFICACIÓN POA"><b>1.- </b>FORMATO DE SOLICITUD DE CERTIFICACI&Oacute;N POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_MOD_4_Y_5_2025.xlsx" download  title="FORMULARIO DE MODIFICACION POA - ACTIVIDADES Y REQUERIMIENTOS"><b>2.- </b>FORMATO DE SOLICITUD DE MODIFICACI&Oacute;N POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_EDICION_CPOAS_2025.docx" download  title="FORMULARIO DE MODIFICACION DE CERTIFICACION POA"><b>3.- </b>FORMATO DE SOLICITUD DE MODIFICACI&Oacute;N DE CERTIFICACION POA</a></li>
    <li><a href="<?php echo base_url(); ?>assets/video/FORM_JUST_SALDOS_CPOAS_2025.docx" download  title="FORMULARIO DE REVERSION DE SALDOS"><b>4.- </b>FORMATO DE SOLICITUD DE REVERSIÓN DE SALDOS</a></li>
  </ul>
...
<div id="contenido">
<a id="abrir" class="abrir-cerrar" href="javascript:void(0)" onclick="mostrar()"><b>LINK HERRAMIENTAS POA </b></a><a id="cerrar" class="abrir-cerrar" onclick="ocultar()">CERRAR LISTA</a>
  <div class="container">
