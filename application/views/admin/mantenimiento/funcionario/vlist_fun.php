                ...
                <section id="widget-grid" class="">
                    <div class="row">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-2 col-lg-3">
                            <section id="widget-grid" align="center" class="well">
                                <?php echo $list_responsables;?>
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="well well-sm well-light">
                                ...
                                <div id="tabs">
                                    <ul>
                                        <li>
                                            <a href="#tabs-c">USUARIOS ADMINISTRATIVOS</a>
                                        </li>
                                        <li>
                                            <a href="#tabs-a">ENCARGADO SEGUIMIENTO POA</a>
                                        </li>
                                    </ul>
                                    <div id="tabs-c">
                                        <div class="row">
                                            ...
                                            <div class="jarviswidget jarviswidget-color-darken">
                                              <header>
                                                  ...
                                                  <h2 class="font-md"><strong>USUARIOS ADMINISTRATIVOS</strong></h2>  
                                              </header>
                                                <div>
                                    ...
                                    <div id="tabs-a">
                                        <div class="row">
                                            ...
                                            <div class="jarviswidget jarviswidget-color-darken" >
                                              <header>
                                                  <span class="widget-icon"> <i class="fa fa-arrows-v"></i> </span>
                                                  <h2 class="font-md"><strong>ENCARGADOS DE SEGUIMIENTO POA </strong></h2>  
                                              </header>
                                                <div>
                                                    <div class="widget-body no-padding">
                                                        <table id="dt_basic" class="table table-bordered" style="width:100%;">
                                                            <thead>
                                                                <tr style="height:55px;" align="center">
                                                                    ...
                                                                    <th style="width:10%;" title="TIPO DE ADMINISTRACI&Oacute;N"><center>TIPO DE ADMINISTRACI&Oacute;N</center></th>
                                                                    <th style="width:10%;" title="DISTRITAL"><center>DISTRITAL</center></th>
                                                                    <th style="width:10%;" title="ROL ASIGNADO"><center>ROL</center></th>
                                                                    <th style="width:10%;" title="SUBACTIVIDAD"><center>SUBACTIVIDAD</center></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                               <?php echo $administradores_segpoa;?>
                                                            </tbody>
                                                        </table>
                                                    </div>
                                                    <!-- end widget content -->
