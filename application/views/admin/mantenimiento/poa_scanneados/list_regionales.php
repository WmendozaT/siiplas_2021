    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mantenimiento</li><li>Mis Poas Scanneados</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
              ...
              <div class="modal-body">
                ...
                <form action="<?php echo site_url().'/mantenimiento/cpoas_scanneados/importar_archivo_pdf' ?>" id="form_file" name="form_file" class="form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <fieldset>
                        <div id="mtit"></div>
                        <div class="col-md-10">
                            <input id="file1" name="file1" type="file" class="file" multiple data-show-upload="false" data-show-caption="true" accept=".pdf,.rar" title="SELECCIONE EL ARCHIVO, DOCUMENTO" style="width:100%;">
                ...
                $(".mod_file").on("click", function (e) {
                    ...
                    $("#file_enviar").on("click", function (e) {
                        ...
                        if (!$valid) {
                            ...
                            alertify.confirm("SUBIR ARCHIVO SCANNEADO REGIONAL ?", function (a) {
                                if (a) {
        ...
        <script type="text/javascript">
            ...
            $(function () {
                $(".enlace").on("click", function (e) {
                    ...
                    $('#content1').html('<div class="loading" align="center"><img src="<?php echo base_url() ?>/assets/img_v1.1/preloader.gif" alt="loading" /><br/>Un momento por favor, Cargando Archivo - <br>'+distrital+'</div>');
                    
                    var url = "<?php echo site_url("")?>/mantenimiento/cpoas_scanneados/get_pdf_poa";
                    var request;
                    if (request) {
                        request.abort();
                    }
                    ...
                    if (response.respuesta == 'correcto') {
                        ...
                        alertify.error("ERROR AL RECUPERAR ARCHIVO PDF");
                    }
