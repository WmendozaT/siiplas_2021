        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                $("#dep_id").change(function () {
                    ...
                    dep_id=$(this).val();
                       $('#content1').html('<div class="loading" align="center"><img src="<?php echo base_url() ?>/assets/img_v1.1/preloader.gif" alt="loading" /><br/>Un momento por favor ... </div>');
                        var url = "<?php echo site_url("")?>/mantenimiento/cconfiguracion/get_caratula_poa";
                        var request;
                        if (request) {
                            request.abort();
                        }
                        ...
                        if (response.respuesta == 'correcto') {
                            $('#tit').html('<b>CARATULA POA - REGIONAL '+response.regional[0]['dep_departamento'].toUpperCase()+'</b>');
