    ...
    <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:90%;" align="center">
      <tr>
        <td style="width:100%; height: 1.2%; font-size: 12pt;" align="center">
            ...
            <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                <tr>
                    <td style="width:100%; height: 1.2%; font-size: 30pt;" align="center"><b>PROYECTOS DE INVERSI&Oacute;N</b></td>
                </tr>
                <tr>
                    <td style="width:100%; height: 5.5%; font-size: 20pt;" align="center">REGIONAL <?php echo strtoupper($regional[0]['dep_departamento']);?></td>
                </tr>
            </table>
            <hr>
        </td>
...
try{
    ...
    $html2pdf->Output('Caratula_principal_PI_'.strtoupper($regional[0]['dep_departamento']).'.pdf');
}
