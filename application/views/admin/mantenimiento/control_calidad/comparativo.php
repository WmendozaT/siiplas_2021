    ...
    <body class="">
        ...
        <div id="main" role="main">
            ...
            <div id="ribbon">
                ...
                <!-- breadcrumb -->
                <ol class="breadcrumb">
                    <li>Mantenimiento</li><li>Ptto. Asignado POA</li><li>Acciones Operativas</li>
                </ol>
            </div>
            <!-- MAIN CONTENT -->
            <div id="content">
                ...
                <section id="widget-grid" class="">
                    <div class="row">
                        ...
                        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-2">
                            <section id="widget-grid" class="well">
                                <a href="<?php echo site_url("").'/select_control_calidad/'.$tp.''; ?>" class="btn btn-success" title="Lista de Operaciones" style="width:100%;">SALIR</a>
                            </section>
                        </article>
