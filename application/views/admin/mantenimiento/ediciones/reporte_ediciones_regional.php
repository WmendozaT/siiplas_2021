...
<page backtop="46mm" backbottom="40mm" backleft="5mm" backright="5mm" pagegroup="new">
    <page_header>
                        ...
                        <tr style="width: 100%; border: solid 0px black; text-align: center; font-size: 8pt; font-style: oblique;">
                            ...
                            <td width=56%; class="titulo_pdf">
                                <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;" align="center">
                                  <tr>
                                    <td style="width:100%; height: 1.2%; font-size: 15pt;" align="center"><b><?php echo $this->session->userdata('entidad');?></b><br>REGIONAL <?php echo strtoupper($dep[0]['dep_departamento']);?></td>
                                  </tr>
                                </table>
                            </td>
        ...
        <div align="center">CONSOLIDADO DE CERTIFICACI&Oacute;N Y MODIFICACI&Oacute;N AL POA<br> (AL <?php echo date("d").' DE '.$mes[ltrim(date("m"), "0")]. " DE ".date("Y");?>)</div><br>
    </page_header>
    <page_footer>
        <hr>
