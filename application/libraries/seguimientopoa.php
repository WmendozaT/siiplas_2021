 ...
 public function tabla_acumulada_evaluacion_servicio($regresion,$tp_graf,$tip_rep){
  ...
  /*---- FUNCION PARA ACTUALIZAR EVALUACION POA POR SERVICIO ----*/
    ...
    public function formularios_mensual($com_id){
      ...
      $tabla.='
          <div class="btn-group">
            <a class="btn btn-default">FORM. SEGUIMIENTO Y EVALUACIÓN POA </a>
...
/*            if($this->tp_adm==1){
                  ...
                  <tr>
                    ...
                    if(count($ejec)!=0){
                      ...
                      if(count($no_ejec)!=0){
                        ...
                        $tabla.='
                        <td align=center title="GUARDAR SEGUIMIENTO POA">ff
  ...
  /// Menu Seguimiento POA (Sub Actividad)
    ...
    public function menu_principal_roles_seguimientopoa(){
        ...
        $vector;
        $n = 0;
        $vector[0]=$this->html_menu_opciones_seguimientopoa(1);
        
        return $vector;
    }

    /*------------- FORMA TABLA MENU SISTEMA ---------------*/
    public function html_menu_opciones_seguimientopoa($o_filtro){
        switch ($o_filtro) {
