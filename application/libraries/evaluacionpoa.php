...
class Evaluacionpoa extends CI_Controller{
    ...
    function cabecera_evaluacionpoa($tp_reg,$dato,$tp_titulo){
      ...
      $tit_rep='';
      if($tp_titulo==1){
        $tit_rep='CUADRO DE AVANCE EVALUACI&Oacute;N POA AL '.$trimestre['0']['trm_descripcion'].' / '.$this->gestion.'';
      }
      elseif($tp_titulo==2){
        $tit_rep='CUADRO DETALLE EVALUACI&Oacute;N POA AL '.$trimestre['0']['trm_descripcion'].' / '.$this->gestion.'';
      }
      elseif($tp_titulo==3){
        $tit_rep='CUADRO DE EVALUACI&Oacute;N POA '.$this->gestion.'';
      }
      else{
       $tit_rep='CUADRO DE EFICACIA '.$trimestre['0']['trm_descripcion'].' / '.$this->gestion.''; 
      }


      $titulo='';
      if($tp_reg==0){
        $titulo='<tr style="font-size: 15pt;">
                  <td colspan="2" style="width:10%; height: 18%;"><b>REGIONAL '.strtoupper ($dato[0]['dep_departamento']).'</b></td>
                </tr>
                <tr style="font-size: 12pt;">
                  <td colspan="2" style="width:10%; height: 15%;">'.$tit_rep.'</td>
                </tr>';
      }
      elseif ($tp_reg==1) {
        $titulo='<tr style="font-size: 15pt;">
                  <td colspan="2" style="width:10%; height: 18%;"><b>'.strtoupper ($dato[0]['dep_departamento']).' - '.strtoupper ($dato[0]['dist_distrital']).'</b></td>
                </tr>
                <tr style="font-size: 12pt;">
                  <td colspan="2" style="width:10%; height: 15%;">'.$tit_rep.'</td>
                </tr>';
        ...
        $titulo='<tr style="font-size: 15pt;">
                  <td colspan="2" style="width:10%; height: 18%;"><b>CONSOLIDADO NACIONAL</b></td>
                </tr>
                <tr style="font-size: 12pt;">
                  <td colspan="2" style="width:10%; height: 15%;">'.$tit_rep.'</td>
                </tr>';
              ...
              <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;">
                <tr>
                  ...
                  <td style="width:85%;">
                    <table border="0" cellpadding="0" cellspacing="0" class="tabla" style="width:100%;">
                        <tr>
                          <td colspan="2" style="width:100%; height: 1%; font-size: 20pt;"><b>'.$this->session->userdata('entidad').'</b></td>
                        </tr>
                        '.$titulo.'
                    </table>
                  </td>
...
////================== PARAMETROS DE EFICACIA 
  ...
  /*---- matriz parametros de eficacia Distrito ----*/
    public function matriz_eficacia_distrital($dist_id){
      ...
      $nro_1=0;$nro_2=0;$nro_3=0;$nro_4=0;
      foreach($unidades as $row){
        if(count($this->model_evalunidad->nro_operaciones_programadas($row['proy_id'],$this->tmes))!=0){
