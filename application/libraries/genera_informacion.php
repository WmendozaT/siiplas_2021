...
/*    public function verif_saldos_disponibles_distrital($dep_id,$dist_id){
    ...
    /// ---Lista de unidades con saldos no programados (DASHBOARD)
    public function lista_unidades_con_saldo_disponible($dep_id,$dist_id){
      $unidades=$this->mrep_operaciones->list_unidades($dist_id,4); /// lista de unidades
      $tabla='  <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th style="width:1%;text-align:center">#</th>
                      <th style="width:20%;text-align:center">UNIDAD / ESTABLECIMIENTO</th>
                      <th style="width:7%;text-align:center">PPTO. ASIGNADO</th>
                      <th style="width:7%;text-align:center">PPTO. PROGRAMADO</th>
                      <th style="width:7%;text-align:center">SALDO</th>
                  ...
                  foreach ($unidades as $row){
                    ...
                    if($ppto[3]!=0){
                      ...
                      <tr bgcolor='.$bg_color.'>
                        ...
                        <td style="text-align:right">'.number_format($ppto[1], 2, ',', '.').'</td>
                        <td style="text-align:right">'.number_format($ppto[2], 2, ',', '.').'</td>
                        <td style="text-align:right">'.number_format($ppto[3], 2, ',', '.').'</td>
