...
!function (a, b, c) {
    !function (a) {
        ...
        function g(a) {
            ...
            !a.sEmptyTable && c && "No hay datos disponibles en la tabla" === b.sEmptyTable && Jb(a, a, "sZeroRecords", "sEmptyTable"), !a.sLoadingRecords && c && "Loading..." === b.sLoadingRecords && Jb(a, a, "sZeroRecords", "sLoadingRecords"), a.sInfoThousands && (a.sThousands = a.sInfoThousands);
            var d = a.sDecimal;
            d && Sb(d)
        }
        ...
        var Kc = function (a, b, c) {
            ...
            return zc(b, function (a) {
                if (!a) {
                    for (f = [], g = 0, h = k.length; h > g; g++)for (e = k[g], i = 0; n > i; i++)f.push({
                        row: e,
                        column: i
                    });
                    return f
        ...
        Xb("cells()", function (a, b, e) {
            ...
            oLanguage: {
                ...
                sInfo: "Mostrando _START_ a _END_ a _TOTAL_ entradas",
