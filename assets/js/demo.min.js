...
$("#ribbon").append('<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-blueDark"></i></span> <form><legend class="no-padding margin-bottom-10">Opciones de diseño</legend><section><label style="display:block;"><input type="checkbox" id="smart-topmenu" class="checkbox style-0" ><span>Menú en la parte <b> superior</b></span></label> <span id="smart-bgimages"></span></section></form> </div>');
